...
const SCREEN = {
  ...
  ABUK: { px: 94, pxDate: "2026-09-03", lib: "2026-08-23", z: -1.208, trend: true, gap: -0.3617, fair: 60, fairAsof: "2026-07-01", rebuilt: false, notes: null, n: 57, c90: 0.9123, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  ...
  AMOC: { px: 13.54, pxDate: "2026-09-06", lib: "2026-09-06", z: -1.03, trend: true, gap: -0.5606, fair: 5.95, fairAsof: "2026-08-06", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 57, c90: 0.8947, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  ...
  ARCC: { px: 76.6, pxDate: "2026-09-06", lib: "2026-09-06", z: -0.385, trend: true, gap: -0.2866, fair: 54.65, fairAsof: "2026-06-30", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 44, c90: 0.9318, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  ...
  BTFH: { px: 3.02, pxDate: "2026-09-03", lib: "2026-08-23", z: -1.144, trend: false, gap: -0.0464, fair: 2.88, fairAsof: "2026-07-01", rebuilt: false, notes: null, n: 56, c90: 0.8393, flag: null, cap: "full", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  ...
  COMI: { px: 138.98, pxDate: "2026-09-03", lib: "2026-09-01", z: -0.427, trend: true, gap: -0.1128, fair: 123.3, fairAsof: "2026-06-29", rebuilt: false, notes: null, n: 57, c90: 0.9123, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  ...
  DSCW: { px: 2.03, pxDate: "2026-09-02", lib: "2026-08-23", z: -0.792, trend: true, gap: -0.5665, fair: 0.88, fairAsof: "2026-07-19", rebuilt: false, notes: null, n: 29, c90: 0.931, flag: null, cap: "partial", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  ...
  EFID: { px: 30.79, pxDate: "2026-09-03", lib: "2026-08-23", z: -0.121, trend: true, gap: -0.101, fair: 27.68, fairAsof: "2026-07-01", rebuilt: false, notes: null, n: 40, c90: 0.95, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  EFIH: { px: 22.97, pxDate: "2026-09-03", lib: "2026-08-23", z: -0.151, trend: true, gap: -0.3835, fair: 14.16, fairAsof: "2026-07-01", rebuilt: false, notes: null, n: 15, c90: 1, flag: null, cap: "thin record", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  EGAL: { px: 381, pxDate: "2026-09-03", lib: "2026-08-23", z: -0.405, trend: true, gap: -0.3438, fair: 250, fairAsof: "2026-07-01", rebuilt: false, notes: null, n: 57, c90: 0.9123, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  EGCH: { px: 14.41, pxDate: "2026-09-03", lib: "2026-08-06", z: -0.898, trend: true, gap: -0.7474, fair: 3.64, fairAsof: "2026-08-06", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 57, c90: 0.9474, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  ELEC: { px: 2.12, pxDate: "2026-09-06", lib: "2026-09-06", z: -1.562, trend: false, gap: -0.8396, fair: 0.34, fairAsof: "2026-08-05", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 57, c90: 0.9298, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  ...
  FWRY: { px: 18.95, pxDate: "2026-09-03", lib: "2026-08-23", z: -0.658, trend: true, gap: -0.2243, fair: 14.7, fairAsof: "2026-07-01", rebuilt: false, notes: null, n: 23, c90: 1, flag: null, cap: "partial", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  GBCO: { px: 28.98, pxDate: "2026-09-03", lib: "2026-08-23", z: -0.701, trend: true, gap: 0.2319, fair: 35.7, fairAsof: "2026-07-07", rebuilt: false, notes: null, n: 57, c90: 0.9474, flag: null, cap: "full", stop: "lenses", why: "momentum call is down" },
  HELI: { px: 8.1, pxDate: "2026-09-03", lib: "2026-08-23", z: 1.302, trend: true, gap: 0.037, fair: 8.4, fairAsof: "2026-07-01", rebuilt: false, notes: null, n: 57, c90: 0.9123, flag: null, cap: "full", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  HRHO: { px: 25.7, pxDate: "2026-09-03", lib: "2026-08-23", z: -1.165, trend: false, gap: 0.0778, fair: 27.7, fairAsof: "2026-07-01", rebuilt: false, notes: null, n: 57, c90: 0.9298, flag: null, cap: "full", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  ...
  ISPH: { px: 12.95, pxDate: "2026-09-03", lib: "2026-08-23", z: -0.499, trend: true, gap: 0.373, fair: 17.78, fairAsof: "2026-07-07", rebuilt: false, notes: null, n: 30, c90: 0.7667, flag: "narrow", cap: "reduced", stop: "lenses", why: "momentum call is down" },
  JUFO: { px: 27.06, pxDate: "2026-09-03", lib: "2026-08-23", z: -0.233, trend: true, gap: -0.0392, fair: 26, fairAsof: "2026-07-01", rebuilt: false, notes: null, n: 57, c90: 0.9474, flag: null, cap: "full", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  KABO: { px: 34.06, pxDate: "2026-09-03", lib: "2026-08-23", z: 0.019, trend: true, gap: -0.9298, fair: 2.39, fairAsof: "2026-07-06", rebuilt: false, notes: null, n: 57, c90: 0.9474, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  ...
  LCSW: { px: 36, pxDate: "2026-09-02", lib: "2026-08-23", z: -0.331, trend: true, gap: 0.0278, fair: 37, fairAsof: "2026-07-06", rebuilt: false, notes: null, n: 57, c90: 0.9123, flag: null, cap: "full", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  ...
  OCDI: { px: 33.52, pxDate: "2026-09-02", lib: "2026-09-01", z: 1.058, trend: true, gap: -0.2115, fair: 26.43, fairAsof: "2026-06-23", rebuilt: false, notes: null, n: 57, c90: 0.9474, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  ...
  ORHD: { px: 42, pxDate: "2026-09-03", lib: "2026-09-01", z: 1.039, trend: true, gap: 0.2807, fair: 53.79, fairAsof: "2026-06-24", rebuilt: false, notes: null, n: 41, c90: 0.9268, flag: null, cap: "full", stop: null, why: "clears every gate on the published numbers" },
  ORWE: { px: 26.76, pxDate: "2026-09-02", lib: "2026-08-23", z: -0.917, trend: true, gap: -0.219, fair: 20.9, fairAsof: "2026-07-01", rebuilt: false, notes: null, n: 57, c90: 0.9123, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  PHAR: { px: 128, pxDate: "2026-09-06", lib: "2026-09-06", z: 1.275, trend: true, gap: -0.5218, fair: 61.21, fairAsof: "2026-08-06", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 56, c90: 1, flag: "wide", cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  ...
  PRDC: { px: 9.78, pxDate: "2026-09-03", lib: "2026-08-23", z: 2.845, trend: true, gap: -0.1585, fair: 8.23, fairAsof: "2026-07-06", rebuilt: false, notes: null, n: 15, c90: 1, flag: null, cap: "thin record", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  ...
  SCEM: { px: 98.52, pxDate: "2026-09-06", lib: "2026-09-06", z: -0.015, trend: true, gap: -0.4608, fair: 53.12, fairAsof: "2026-08-06", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 57, c90: 0.9298, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  ...
  TMGH: { px: 96.6, pxDate: "2026-09-02", lib: "2026-08-23", z: 0.053, trend: true, gap: 0.523, fair: 147.12, fairAsof: "2026-06-17", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 57, c90: 0.9298, flag: null, cap: "full", stop: null, why: "clears every gate on the published numbers" },
