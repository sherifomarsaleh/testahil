...
**Trigger.** [R-GAP-01], as amended 03-Sep-2026. Central **EGP 9.91** against a spot of
...
**−26.6%** below the price, past the ten per cent trigger, so this review runs before the
files are staged.
...
**The conclusion of this review, stated first.** The central does not move. One real defect
was found and it is in a cross-check rather than in the answer — the relative-multiple lens
was anchored on the traded price, and moving the price is what exposed it. Everything the
eight headings look for was examined and the remaining seven are clean. The disagreement
with the market is genuine and it is legible: **the market is paying for a gross margin of
11.17% sustained for ever, and this study forecasts the base year's 9.65%.** Both numbers
sit inside the range this company has actually filed, so this is a disagreement about
persistence, not about arithmetic.
...
One honest caveat, carried from the study's own text rather than invented here: the base
year's margin of 9.65% is itself a blend of a weak first half and a strong recent quarter
(3M Mar-2026 at 10.19%, 6M Jun-2026 at 12.43%). A base year struck on the most recent
period alone would be materially higher and the fair value materially higher with it. The
study takes the trailing twelve months deliberately, and **that choice is worth flagging
because it runs against the direction of this gap** — it is one of the reasons the central
sits below the price, and it is a conservative choice rather than an error.
...
| item | state |
|---|---|
| central | EGP 9.9142 — **unchanged** by this review |
| spot | EGP 13.50, 3 September 2026, `engine/prices/SUPPLIED_03-09-2026.json` |
| gap | −26.6% |
| headings clean | 1, 2, 3, 4, 5, 6, 7 |
| heading with a finding | 8 — the relative lens was anchored on the price |
| delivered numbers moved | none (the lens carried no weight); bear/bull rebuilt on filed evidence |
...
*AUDITED CENTRAL: 9.9142* — the figure this review audits, stated so a job outside the study
