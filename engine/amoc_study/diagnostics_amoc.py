    ...
    cj = {
        ...
        "judgements": [
            ...
            row("the base anchor: the twelve-month base, or the latest reviewed half",
                ...
                "is not adopted in this edition BY SEQUENCING: re-anchoring moves "
                "the central and therefore the workbook, the document, the "
                "bibliography, the gap review and the QC gate with it, which is a "
                "re-issue rather than a field, and it belongs with the four other "
                "undisputed corrections that stack with it. THE REASON RECORDED "
                "HERE UNTIL 18-09-2026 WAS FALSE and it read 'because [R-VCAL-01] "
                "takes levers ONE AT A TIME and halts where the stack would cross "
                "the price'. That stop rule governs levers promoted from the "
                "valuation calibration and halts on the POOLED BIAS across the "
                "book crossing zero, never on one study's distance from one quote, "
                "and reading it that way makes the traded price the thing a "
                "correction may not pass -- the reverse-engineering this house "
                "prohibits outright, facing the other way. THE MEASUREMENT IS "
                "UNCHANGED: the escalator correction already moved this study from "
                "26.6%% below to 12.3%% below, and this one lands 35.9%% above; "
                "that it lands above the price is an OUTCOME and is not a reason "
                "either way. Published, priced, and owed by the next edition"
