...
checks = [
    ...
    ('Product lines — calendar 2025 revenue', g('Product Lines', f"E{LG_['rev_cy25']}"),
     BASE['rev_cy25'], 1.0),
    ('Product lines — reconciliation factor', g('Product Lines', f"E{LG_['recon']}"),
     D['unit']['recon'], 0.0005),
    ('Product lines — solved specialty margin', g('Product Lines', f"B{LG_['m_spec']}"),
     D['unit']['m_spec'], 0.0002),
    ('Product lines — solved fuel margin', g('Product Lines', f"B{LG_['m_fuel']}"),
     D['unit']['m_fuel'], 0.0002),
