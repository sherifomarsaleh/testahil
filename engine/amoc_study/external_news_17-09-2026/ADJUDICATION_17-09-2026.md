# AMOC — external news returns, adjudicated

**Received 2026-09-17.** Two returns, kept apart: **A** (delivered in chat, engine not
labelled) and **B** (delivered as a Word document, engine not labelled). Runbook step 4.

**This file carries no valuation figure and nothing here has entered the model.** Every
item below is a LEAD with its trace status stated. What is traced is traced to a document
I opened myself on 2026-09-17, named with its URL; what is not, says so.

---

## 0. Primary access, established 2026-09-17 — this is the most reusable thing in the pass
...
registered attempt either way.

---

## 1. What the company's own site says, read directly

- **Media centre — latest news item 29-06-2026. Latest press release 30-06-2026.
  NOTHING after 30 June 2026.**
- **Financial statements index carries, at the company's own hand:** consolidated and
  standalone statements at **30-6-2026** and at **31-3-2026**, and the full 2024–2025 series.
- **Shareholder structure page** (read 2026-09-17):

  | Holder | % |
  |---|---|
  | شركه الإسكندرية للبترول — Alexandria Petroleum Company | 20.77 |
  | شركه الاهلي كابيتال القابضة — Al Ahly Capital Holding | 15.03 |
  | شركه مصر للتامين — Misr Insurance | 5.48 |
  | صندوق التامين الاجتماعي للعاملين بالقطاع الحكومي | 5.16 |
  | صندوق التامين للعاملين بقطاع الاعمال العام والخاص | 5.00 |
  | شركه مصر لتأمينات الحياه — Misr Life Insurance | 4.54 |
  | الجمعية التعاونية للبترول — Cooperative Petroleum | 3.57 |
  | مصر كابيتال — Misr Capital | 3.544 |

- **Registered Arabic name, from the issuer's own site:** شركة الإسكندرية للزيوت المعدنية.
  Both returns give this and it is confirmed. The prompt's first task is closed.
...
- MoU "مذكرة الشروط الأساسية لبدء الدراسة الفنية التفصيلية" — heads of terms to begin the
  detailed technical study. **Not a construction contract and not a financial close.**
- CHP plant, **initial 16 MW, expandable to 30 MW**, **BOOT**, investment **up to USD 50mn**.
- Targets **100% of AMOC's electricity** and **70% of its industrial steam**.
- Expected total annual saving **≥ EGP 174mn**: **EGP 49mn to AMOC**, EGP 125mn to the state
  from ~363 thousand MMBtu of gas saved. **15%** reduction in AMOC's carbon footprint.
- `alamaltaqa.com/51437` (dated Friday 31 July 2026) carries the same event independently:
  capacity expandable to 30 MW, USD 50mn, BOOT, ~15% annual fuel-consumption reduction.

**Three cautions that ride with it:**
1. **Both sources are trade press, not primary.** The primary would be AMOC's own disclosure
   or Intro Utilities'. **AMOC's own media centre does not carry it** — a USD 50mn MoU signed
...
3. **EGP 49mn a year is the company's share of a projected saving, from a press account of a
   heads-of-terms.** Against this company's scale it is small, and an MoU for a feasibility
...
### 2.4 Both returns agree, and the agreement is weak evidence

No management change, no litigation, no capital increase or split, no new debt facility. Two
engines agreeing on an absence neither can source is two models agreeing. Recorded as such.
...
- **FY2026 profit guidance of EGP 2.1bn**, raised by the board and carried on the company's own
  ...
  management's forward target as an input inherits its lean. It is registered as a claim to
  score, not as a number to use. It is also *inside* the consumed window and was not swept,
  because this study has no sweep register at all.
- **Any figure either return presents as AMOC's reported results.** Historicals come from the
  issuer's own statements, which are on its own site and reachable.
...
2. **Perplexity warned explicitly against attributing Alexandria Petroleum Company's refinery
   ...
   narrative is established**, and none of it enters anything.
