"""AMOC — forward cone strike via the identical production chain
...
Q_ANNUAL = 0.0879   # DPS EGP 0.80 a year (EGP 0.40 declared for H2-2025) over a 9.10 spot

prof = MP.PROFILES['EG']
raw = load_ohlc(os.path.join(HERE, 'AMOC_Stock_Price_History.csv'))
df, rep = clean_ohlc(raw, 'AMOC', verbose=False, market='EG')
