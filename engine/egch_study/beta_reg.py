"""EGCH beta — tier-1 own-stock weekly regression against an equal-weight EGX composite
...
out = dict(
    ...
    plausibility=dict(
        ...
        net_cash_note=("Leverage read deferred to the filings pass: the damping or amplification of equity beta by the actual net-debt position is assessed once the "
                       "balance sheet is built from the audited statements, not assumed here.")),
)
