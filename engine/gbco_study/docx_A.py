...
rows = [
 ...
 ['1 month', '50,000 paths · 16 factors', f"p5 {q20['5']:.0f} · p50 {q20['50']:.1f} · p95 {q20['95']:.0f}", 'Median above spot'],
 ['3 months', 'same engine, longer horizon', f"p5 {q60['5']:.0f} · p50 {q60['50']:.0f} · p95 {q60['95']:.0f}", 'Wide, right-skewed'],
