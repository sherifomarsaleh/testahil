"""ADNOCDIST — forward cone strike via the identical production chain
...
Q_ANNUAL = 0.0511   # FY2025 dividends paid AED 2,599,146k over 12,500,000k shares = AED 0.2079/share, over the 4.07 close

prof = MP.PROFILES['AE']
raw = load_ohlc(os.path.join(HERE, 'ADNOCDIST_Stock_Price_History.csv'))
df, rep = clean_ohlc(raw, 'ADNOCDIST', verbose=False, market='AE')
