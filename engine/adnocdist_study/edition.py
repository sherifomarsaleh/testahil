"""THE EDITION DATE OF THE ADNOCDIST STUDY, WRITTEN ONCE.
...
STUDY_DOCX = 'ADNOCDIST_Valuation_Study_' + _D + '.docx'
MODEL_XLSX = 'ADNOCDIST_Valuation_Model_' + _C + '.xlsx'
BIBLIO_DOCX = 'ADNOCDIST_Bibliography_' + _D + '.docx'
