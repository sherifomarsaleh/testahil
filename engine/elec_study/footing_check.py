#!/usr/bin/env python3
"""ELEC — every total a reader sees, reproduced from the rows printed above it.
...
DOCS = [d for d in (_latest('ELEC_Valuation_Study_*.docx'), _latest('ELEC_Bibliography_*.docx')) if d]
...
if __name__ == '__main__':
    ...
    sys.exit(TF.report(examined, problems, 'ELEC'))
