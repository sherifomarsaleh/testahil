# STC — GAP REVIEW, 10-09-2026  [R-GAP-01]

*AUDITED CENTRAL: 36.0596* — the figure this review audits.
*AUDITED GAP: -17.8%* — against the latest known price of SAR 43.86.

**WHY THIS EDITION EXISTS.** Two things moved since 05-09-2026 and both are
cost-of-capital corrections, not changes of view.

**THE COUNTRY PREMIUM STOPPED BEING MULTIPLIED BY BETA [R-COC-03].** The cost of equity
read rf* + beta x the WHOLE premium. Saudi Arabia's country risk is a charge on being
here; it does not scale with a stock's covariance with its own index. This beta is 0.7093 —
BELOW one — so the retired identity was charging LESS country risk than a flat charge, and
correcting it RAISES the rate and LOWERS the answer. The premium now splits by Damodaran's
identity: 4.230% mature, 1.490% country, beta on the mature leg alone.

**AND THE BETA ARTEFACT WAS BEHIND THE MODEL.** The study's own assertion refused to build:
the committed artefact recorded 0.707829 while the model discounted at 0.709258, and the rule
is that the artefact is what the gates read. beta_reissue.py was re-run in the same pass,
as that assertion instructs.

  cost of equity   8.589% -> 9.030%   (+44bp)
  cost of capital  8.133% -> 8.531%   (+40bp)
  central          SAR 38.0806 -> 36.0596   (-5.3%)
  gap              -13.2% -> -17.8%

Everything below is the 05-09-2026 review, restated at the numbers the study now
publishes. Nothing in its findings changed: the corrections above are to the discount
rate, not to the forecast, the base year, the balance sheet or any claim about the record.
...
*AUDITED CENTRAL: 36.0596* — the figure this review audits, stated so a job outside the
study can tell whether the review still describes the answer the study publishes.

*AUDITED GAP: -17.8%* — the disagreement this review interrogates, stated so a job outside
...
than filled. The answer moved 38.1426 to 38.0806, -0.163%, and the gap from -13.0% to -13.2%. This edition moves it again, to 36.0596 and -17.8%, on the two rate corrections named at the top.
