...
H2('1.9 · Sensitivity')
figure('fig2_sens.png', 6.4, 'Figure 2 — DCF fair value across cost-of-equity shifts and '
       'terminal growth. Rebuilt so the centre cell equals the base case (the first edition\'s '
       'grid used a different terminal convention from its own base — an audit finding). Note '
