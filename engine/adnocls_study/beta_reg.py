...
out = dict(
    ...
    index_file=SANCTIONED['index_file'],
    index_asof=SANCTIONED['index_asof'],
    market=SANCTIONED['market'],
    exchange=SANCTIONED['exchange'],
    conforming=bool(SANCTIONED['conforming']),
