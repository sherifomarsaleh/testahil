...
RAW = '/home/claude/repo/engine/raw_ohlc/EG'
NAMES = ['ABUK','ADIB','BTFH','CCAP','CLHO','COMI','DSCW','EFID','EFIH','EGAL','EMFD',
...
import pickle
with open('/home/claude/selection/f5_forensics.pkl', 'wb') as f:
    pickle.dump(dict(summary=summary, detail=detail), f)
print('\nSaved f5_forensics.pkl')
