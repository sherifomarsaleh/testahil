...
XLSX = os.path.join(HERE, 'DU_Valuation_Model_08092026_public.xlsx')
...
checks = [
    ...
    ('Fundamental — panel median', g('Fundamental Valuation', ANCH['fv_panel']), D['panel_centre'], 0.02),
    ('Fundamental — Framing 1 (measured beta)', g('Fundamental Valuation', ANCH['fv_framing1']),
     DCF['ps'], 0.02),
    ('Fundamental — contested judgement gap (Framing 1 less Framing 2)',
     g('Fundamental Valuation', ANCH['fv_gap']), DCF['ps'] - DCF['ps_mkt_term'], 0.02),
    ('Summary weighted central', g('Summary', 'C9'), D['central'], 0.02),
    ('Summary terminal value share', g('Summary', ANCH['summary_tv_share']),
     DCF['tv_share'], 0.002),
    ('Summary contested-judgement alternative (no re-rating)',
     g('Summary', ANCH['summary_alt']),
     DCF['ps_mkt_term'], 0.02),
