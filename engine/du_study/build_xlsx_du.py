...
block('Cost of capital', [
    ...
    ('sov', 'UAE sovereign default spread (netted out; Aa2 rating basis)',
     IN['sov_spread_rating'], PCT),
    ('erp', 'Equity risk premium (UAE total, rating basis)', IN['erp_rating'], PCT),
    ('beta', 'Beta (DU weekly vs DFM General Index, 5y)', IN['beta'], '0.000'),
...
coc = [
    ...
    ('Beta (DU weekly vs its own index, the DFM General, 5 years)', f'={a("beta")}',
     IN['beta'], '0.000'),
    ('Equity risk premium (UAE total, rating basis)', f'={a("erp")}', IN['erp_rating'], PCT2),
    ...
    ('Terminal risk-free net of the sovereign spread', '=C48-C36',
     IN['rf_term'] - IN['sov_spread_rating'], PCT2),
...
for lab, v, fmt, green in [('Simulated paths', 50000, NUM0, False),
                           ...
                           ('Spot price (AED)', '=Summary!C14', PX, True),
