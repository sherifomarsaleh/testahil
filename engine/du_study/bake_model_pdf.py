...
SRC = os.path.join(HERE, 'DU_Valuation_Model_08092026_public.xlsx')
...
with tempfile.TemporaryDirectory() as tmp:
    baked = os.path.join(tmp, 'DU_Valuation_Model_08092026_public.xlsx')
    wb.save(baked)
    ...
    out = os.path.join(HERE, 'DU_Valuation_Model_08092026_public.pdf')
