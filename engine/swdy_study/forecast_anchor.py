...
D['forecast_anchor'] = dict(
    ...
    note=(
        ...
        "mechanism the model does not run, asserted on a measurement a small "
        "fraction of the size of the step it is offered to explain, is the "
        "assumption wearing one. (c) A ONE-OFF IN THE LATEST REVIEWED PERIOD. One is disclosed and "
        ...
        "SUBSIDY OR LEVY WITHDRAWAL, (f) CAPACITY COMMISSIONING DRAG: nothing in "
        "this study's own input register -- its record of what the filings disclose, "
        "four fields to a figure -- names a contracted or administered price step, a "
        "subsidy, levy or quota change, or a capacity programme whose commissioning "
        "costs land before its revenue. No order book or backlog figure is disclosed "
        "in any of the audited filings or the Q1-2026 interim either, which is the "
        "absence the constructions growth driver already records. "
