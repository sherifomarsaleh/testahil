...
putf(wsD, 'C21', f"=C20+{AR('Beta (five-year weekly, vs the Dubai index)')}*{AR('Terminal equity risk premium')}",
     W['ke_term'], PCT2)
...
def vec(lbl, xs, vals, xfmt='{}'):
    ...
    r += 2
vec('Beta', SN['beta_grid'], SN['grid_beta'])
