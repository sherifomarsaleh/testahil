"""AIRARABIA — forward cone strike via the identical production chain
...
q_annual: FY2025 dividend of AED 0.30/share (30 fils) approved at the AGM of
12-Mar-2026 and paid in 2026 — 0.30 / 5.24 spot = 5.73% trailing yield. Sourced,
not defaulted."""
import sys, os, json
...
DPS = 0.30           # AED/share, FY2025 dividend approved 12-Mar-2026

prof = MP.PROFILES['AE']
raw = load_ohlc(os.path.join(HERE, 'AIRARABIA_Stock_Price_History.csv'))
df, rep = clean_ohlc(raw, 'AIRARABIA', verbose=False, market='AE')
...
assert width_mult == 1.0, "AE carries no width overlay — must be exactly 1.0"
