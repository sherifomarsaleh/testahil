...
- **Reference study to match** — the MODEL STUDY is **SWDY_Valuation_Study_05-08-2026** (`engine/swdy_study/`): its sections list, sheet list and research depth are the standard for EVERY class [ADOPTED 08-Aug-2026; TMPV retired as template, EAND retired as operating-co exemplar]. The class picks the LENS PATTERN only: SWDY (operating company / diversified industrial), ADCB (bank), Alpha Dhabi (holding company).
