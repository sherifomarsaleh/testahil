"""PHAR — forward cone strike via the identical production chain
...
Q_ANNUAL = 0.0269   # FY2025 proposed DPS EGP 3.50 (EGP 590,645,125 on 168,755,750 shares) over the 130.05 close

prof = MP.PROFILES['EG']
raw = load_ohlc(os.path.join(HERE, 'PHAR_Stock_Price_History.csv'))
df, rep = clean_ohlc(raw, 'PHAR', verbose=False, market='EG')
