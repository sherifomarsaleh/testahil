#!/usr/bin/env python3
"""PHAR -- the BUILD ORDER for this study's numbers file, recorded because nothing
...
#   compute.py           REBUILDS study_numbers.json from the input register, and
#                        writes `forecast_anchor` and `lens_record` itself
#   bridge_record.py     adds `bridge_record`            [R-BRIDGE-01]
STEPS = ('compute.py', 'bridge_record.py')
