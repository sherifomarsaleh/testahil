...
def main():
    ...
    print("\nCRITERIA 2, 3, 5 and 6 ARE NOT MEASURED HERE AND ARE NOT REPORTED AS "
          ...
          "  3  CORRECTED 07-09-2026 — this line NAMED THE WRONG SCORE and a\n"
          "     2027 date was read off it and reported for the WHOLE criterion.\n"
          "     [R-VCAL-01] fixes TWO series; the criterion opens on the\n"
          "     CONTEMPORANEOUS one, which score.py's own docstring calls\n"
          "     'measurable the moment a vintage exists'. Only its gap-closure\n"
          "     clauses wait on maturity. MEASURED clause by clause since\n"
          "     07-09-2026 by engine/method_reassessment/criterion3.py; run it\n"
          "     for the six verdicts and for what is actually blocking.\n"
