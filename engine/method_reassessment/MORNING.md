...
**If you want one thing looked at first when you read this**, it is item 12: whether two years is enough to set a growth rate for a business this size, or whether the study should wait for the investor-relations disclosure before publishing any number at all. That is a judgement about how much evidence a driver needs, and it is yours rather than mine. **The default if you say nothing is that the work continues on getting the disclosure rather than on adjusting the rate.**
