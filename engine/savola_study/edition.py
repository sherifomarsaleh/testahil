"""THE EDITION DATE OF THE SAVOLA STUDY, WRITTEN ONCE.

Adopted 09-09-2026 with [R-ENF-06]. The date was typed in 10 places in this directory:
...
STUDY_DOCX = 'SAVOLA_Valuation_Study_' + _D + '_public.docx'
MODEL_XLSX = 'SAVOLA_Valuation_Model_' + _C + '_public.xlsx'
BIBLIO_DOCX = 'SAVOLA_Bibliography_' + _D + '.docx'
