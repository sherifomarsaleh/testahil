...
checks = [
    ...
    ('Segments FY2026E revenue', ('Segments', f"C{XP['anchors']['seg']['rev']}"), F['rev'][0], 1.0),
    ('Segments FY2026E gross margin (OUTPUT row)', ('Segments', f"C{XP['anchors']['seg']['gm']}"), F['gm'][0], 0.0005),
    ('Expert 3 base equals the DCF lens (EP reconciliation)', ('Fundamental Valuation', f"C{XP['anchors']['fund']['e3']}"), LN['dcf']['base'], 0.02),
    ('Panel median (live MEDIAN formula)', ('Fundamental Valuation', f"C{XP['anchors']['fund']['median']}"), D['panel_centre'], 0.02),
