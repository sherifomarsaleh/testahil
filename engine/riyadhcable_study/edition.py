"""THE EDITION DATE OF THE RIYADHCABLE STUDY, WRITTEN ONCE.

Adopted 09-09-2026 with [R-ENF-06]. The date was typed in 7 places in this directory:
...
STUDY_DOCX = 'RIYADHCABLE_Valuation_Study_' + _D + '_public.docx'
MODEL_XLSX = 'RIYADHCABLE_Valuation_Model_' + _C + '_public.xlsx'
BIBLIO_DOCX = 'RIYADHCABLE_Bibliography_' + _D + '.docx'
