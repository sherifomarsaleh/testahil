...
LESSONS = [
    ...
    L("L-328", "ALL", None,
      ...
      "life. Where assets are depreciated to a RESIDUAL VALUE the "
      "charge is (cost less residual) over life, so the same "
      "accumulated balance buys more years and the ratio OVERSTATES "
      "the age; where a useful life has been REASSESSED mid-life the "
      "charge is not level across the base's history and the identity "
      "is broken outright rather than merely biased. Both are "
