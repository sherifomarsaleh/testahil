...
LINES = [
 ...
 'PROVENANCE LIMIT, STATED PLAINLY. NO SOURCE DOCUMENT WAS OPENED. Not the audited statements, not the annual',
 'report, not the investor presentation, not the exchange filing, and not the press articles reporting them:',
 'the environment\'s egress policy refused every external financial host at the connection stage. Revenue,',
 'profit, operating income, the balance-sheet totals and both dividend distributions are carried as RELAYED in',
 'web-search summaries of EGX-filing coverage and of aggregations of S&P Global Market Intelligence data —',
 'two steps from the audited print, not one. Where two aggregations disagree',
