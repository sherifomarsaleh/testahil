...
checks = [
    ...
    ('Unit build: FY2025 total despatches', ('Unit Build', 'B18'),
     D['unit_calibration']['vol_fy25'], 0.001),
    ('Unit build: mill utilisation', ('Unit Build', 'B14'),
     D['unit_calibration']['util_fy25'], 0.001),
    ('Unit build: clinker produced (Mt)', ('Unit Build', 'B7'),
     D['unit_calibration']['clk_prod'], 0.001),
    ('Unit build: cement produced (Mt)', ('Unit Build', 'B12'),
     D['unit_calibration']['cem_prod'], 0.001),
    ('Unit build: LOCAL CEMENT PRICE, derived', ('Unit Build', 'B22'),
     D['unit_calibration']['price_loc_derived'], 1.0),
    ('Unit build: EXPORT CEMENT PRICE USD, derived', ('Unit Build', 'B26'),
    ...
    ('Unit build: revenue residual against AUDITED', ('Unit Build', 'B78'),
     D['bottom_up'][0]['rev'] / D['inputs']['rev_fy25']['value'] - 1, 0.001),
    ('Unit build: EBITDA residual against AUDITED', ('Unit Build', 'B81'),
     D['bottom_up'][0]['ebitda'] / H['ebitda'][2] - 1, 0.001),
    ('Unit build: peak kiln utilisation stays below 100%', ('Unit Build', 'B94'),
     max(b['kiln_util'] for b in D['bottom_up'][1:]), 0.001),
    ('Unit build: peak mill utilisation stays below 100%', ('Unit Build', 'B98'),
