...
checks = [
    ...
    ('Unit build: FY2025 volume derived', ('Unit Build', 'B12'),
     D['unit_calibration']['vol_fy25'], 0.001),
    ('Unit build: implied utilisation', ('Unit Build', 'B14'),
     D['unit_calibration']['util_fy25'], 0.001),
    ('Unit build: FY2025 cash cost per tonne', ('Unit Build', 'B27'),
     D['unit_calibration']['cash_cost_t'], 0.5),
    ('Unit build: reconstructed FY2025 revenue', ('Unit Build', 'B54'),
     D['bottom_up'][0]['rev'], 1.0),
    ('Unit build: revenue residual against AUDITED', ('Unit Build', 'B56'),
     D['bottom_up'][0]['rev'] / D['inputs']['rev_fy25']['value'] - 1, 0.001),
    ('Unit build: EBITDA residual against AUDITED', ('Unit Build', 'B59'),
