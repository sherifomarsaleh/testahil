"""THE EDITION DATE OF THE ADNOCDRILL STUDY, WRITTEN ONCE.

Adopted 09-09-2026 with [R-ENF-06]. The date was typed in 9 places in this directory:
...
STUDY_DOCX = 'ADNOCDRILL_Valuation_Study_' + _D + '.docx'
MODEL_XLSX = 'ADNOCDRILL_Valuation_Model_' + _C + '.xlsx'
BIBLIO_DOCX = 'ADNOCDRILL_Bibliography_' + _D + '.docx'
