...
def build(path):
    ...
    for label, val, fmt, src in [
        ...
        ("Delivery growth, real, slower reading", MP["DELIVERY_REAL_CAPACITY"],
         PCT, "it scales with prices and no more"),
        ("Delivery growth, real, faster reading", MP["DELIVERY_REAL_RECOVERY"],
         PCT, "its own 2019-2025 real rate"),
        ("Long-run real growth", MP["TERMINAL_REAL_GROWTH"], PCT,
         "in the converged state, beside a converged discount rate"),
        ("Share of contracted sales that enters the order book",
         MP["BACKLOG_CAPTURE"], NUM2,
         "measured on the company's own two disclosed series; FY2025 was 48.1%"),
        ("Long-run nominal growth", MP["TERMINAL_GROWTH"], PCT,
         "4% terminal inflation compounded with 2% real"),
