...
const TICKERS = {
  ...
  EGCH: {
    ...
    fairAsof: "2026-08-06",   // the close the FAIR VALUE is struck on — not the publication date in the filename
    ccy: "EGP",
    fair: { bear: 0.00, base: 3.76, full: 15.47 },   // 1 Sep 2026 - four lenses, one field, EGP 0.00 to 15.47. Weighted central 3.76 on FCFF DCF 45% / relative 20% / normalised 20% / book 15%. THE CASH-FLOW LENS IS PUBLISHED BOTH WAYS AND NEVER AVERAGED: -0.63 carried through, 3.43 stopped - a gap of 4.05, the single judgement deciding this company. Rebuilt 1 Sep 2026 on a conforming EGX30 beta (1.030, replacing a withdrawn composite), a terminal inflation equal to terminal growth (5%/5%, the 8 Aug edition discounted a 5%-growth perpetuity at a 7%-inflation rate), a currency path derived from the inflation identity with the dollar debt carried at local-equivalent cost year by year on that same path, and years three to five published as ranges from the fundamental calibration record (55 cells, 13 origins, FY2008-FY2025). Central 73.1% below the 13.98 close; audited under the gap review in the study directory - the discount is the capital programme and the Egyptian cost of capital, published both ways, not a defect the audit could find.
    dist: {
