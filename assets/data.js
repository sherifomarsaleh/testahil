...
const SITE = { updated: "2026-08-07", latest: "SWDY" };  // latest = the LAST-PUBLISHED study (drives the homepage hero); set this on every publish
...
const TICKERS = {
  SWDY: {
    ...
    asof: {
      ...
      tech: { data:"2026-08-05", computed:"2026-08-07" }
    },
    files: {
