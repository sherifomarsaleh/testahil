...
,
  ...
  },
  {
    ...
    cal:"matches",
    note:"PARITY under the fitted UAE market profile (9-name ADX/DFM panel, fat-tailed t/4 d.o.f., width_cal 1.07). Name-level CRPS skill roughly +0.7\u20130.9% vs a carry-anchored random-walk benchmark with the bootstrap 90% CI spanning zero, robust across block sizes {2,3,4} \u2014 a calibrated distribution, no single-name edge demonstrated or claimed. This name was folded in as the 10th panel member (its OHLC supplied 10-Jul), which CONFIRMS the fit at nu=4/cal=1.077; it supersedes the provisional 1-name Gaussian self-fit (width_cal 1.042) the study was published under. Carry-anchored drift: 3M EIBOR 3.93%, no ex-dividend date in the window (q=0). TIMING FLAG: the anchor pre-dates the 7\u20138 Jul ceasefire collapse \u2014 this cohort will be graded inside the war-regime window; outlier-triggered out-of-cycle review applies if structurally surprising.",
