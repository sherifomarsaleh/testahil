...
const TICKERS = {
  ...
  EGCH: {
    ...
    fairAsof: "2026-08-06",   // the close the FAIR VALUE is struck on — not the publication date in the filename
    ccy: "EGP",
    fair: {  bear: 0.00, base: 3.64, full: 15.47 },   // PRE-CALIBRATION. HELD BACK FROM THE SITE, DELIBERATELY. The fundamental-calibration rebuild of this name is COMPLETE and its new range is recorded in engine/fv_movement.json and in the study's own study_numbers.json, but per instruction of 1 September 2026 nothing from the calibration campaign goes live one name at a time: the whole book publishes together at the end, in a new location, with the valuation report as a PDF and the workbook beside it. The number below is therefore the PRE-CALIBRATION one (9 Aug 2026 edition: four lenses, one field, EGP 0.00 to 15.47, weighted central 3.64), and the calibrated deliverables are staged under engine/publish_queue/. The calibrated range is 0.00 / 3.76 / 15.47 (edition of 1 Sep 2026, against a latest known close of 13.98), built on a conforming EGX30 beta, the cost of capital through the house builder with the dollar debt at local-equivalent cost year by year, terminal inflation equal to terminal growth, and this name's own fundamental walk-forward (FULL, 55 cells). See engine/egch_study/GAP_REVIEW_01-09-2026.md.
    dist: {
  ...
  ARCC: {
    ...
    ccy: "EGP",
    fair: { bear: 49.53, base: 54.65, full: 61.71 },      // PRE-CALIBRATION. HELD BACK FROM THE SITE, DELIBERATELY. The fundamental-calibration rebuild of this name is COMPLETE and its new range is recorded in engine/fv_movement.json and in the study's own study_numbers.json, but per instruction of 1 September 2026 nothing from the calibration campaign goes live one name at a time: the whole book publishes together at the end, in a new location, with the valuation report as a PDF and the workbook beside it. The number below is therefore the PRE-CALIBRATION one, and the calibrated deliverables are staged under engine/publish_queue/. The calibrated range is 48.75 / 54.10 / 59.53 (revision 4, 1 Sep 2026, against a latest known close of 59.00), built on the H1-2026 reviewed accounts, a tier-2 peer beta replacing a composite that SIGCM clause 6 calls a hard fail, a bridge standing on the disclosed 30-June balance sheet, and this name's own fundamental walk-forward. See engine/arcc_study/GAP_REVIEW_01-09-2026.md.
    dist: {
  ...
  AMOC: {
    ...
    fairAsof: "2026-08-06",   // the close the FAIR VALUE is struck on — not the publication date in the filename
    ccy: "EGP",
    fair: { bear: 4.09, base: 5.95, full: 8.52 },      // PRE-CALIBRATION, ROLLED BACK 1 Sep 2026. HELD BACK FROM THE SITE, DELIBERATELY. The fundamental-calibration rebuild of this name is COMPLETE and its new range is recorded in engine/fv_movement.json and in the study's own study_numbers.json, but per instruction of 1 September 2026 nothing from the calibration campaign goes live one name at a time: the whole book publishes together at the end, in a new location, with the valuation report as a PDF and the workbook beside it. The number below is therefore the PRE-CALIBRATION one, and the calibrated deliverables are staged under engine/publish_queue/. The calibrated range is 5.53 / 8.64 / 12.48 (1 Sep 2026). This one HAD gone live before the batch-publication instruction and is reverted here to its frozen baseline; the baseline is recoverable because engine/fv_movement.py snapshot captured it before the rebuild, which is exactly what that step is for.
