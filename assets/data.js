...
const SITE = { updated: "2026-08-23", latest: "SAVOLA" };  // latest = the LAST-PUBLISHED study (drives the homepage hero); set this on every publish
...
,
  ...
  //      latest library close. Append-only.
  {
    instrument:"XPTUSD", asset_class:"metal",
