...
const TICKERS = {
  ...
  GBCO: {
    ...
    spotDate: "close 22 Jul 2026",
    ccy: "EGP",
    fair: { bear: 19.4, base: 34.2, full: 47.4 },      // FUNDAMENTAL REFRESH 19 Aug 2026 (re-issues the 08-Jul-2026 study, amended 09-Jul, on the H1-2026 disclosure set: KPMG-reviewed interim FS 30-Jun-2026 + 2Q/1H26 results release, both 13-Aug-2026). Weighted central 34.2. THE STUDY'S CENTRAL JUDGEMENT IS COMPUTED BOTH WAYS AND NEVER AVERAGED: MNT-Halan (stake 42.93% per the FS note 34 — supersedes the press release's 41.61%, which described the post-second-closing position) at the Jun-26 round mark (USD 1.4bn x 50.71 = EGP 30.5bn -> SOTP 35.22, central 34.16 = the published base) vs at the company's OWN equity-method carrying value (EGP 15.72bn, KPMG could not verify it — qualified review conclusion, second consecutive period -> SOTP 22.99, central 29.26). bear 19.4 lives in the book-mark world with operating setbacks; full 47.4 in the round-mark world. Four lenses: split-legs SOTP (40%) 35.22/22.99, restated book & sustainable return (15%) 30.82, relative multiples (20%) 26.80 on FY26E EPS 2.82, normalized mid-cycle earnings (25%) 40.34. WACC rebuilt under v2: rf* = 22.92 (10Y, 19-Aug-26) minus Egypt's own default spread (CDS 3.41 / rating 6.37), ERP 9.41/13.94 both bases, beta 0.893 via own_stock_beta vs EGX30 (n=255 weekly, R2 0.24 — replaces the assumed 1.0), Kd 20.82% = the filing's own H1-26 EGP average on an all-variable book, auto-leg debt weights -> WACC 22.72% CDS / 23.33% rating (prior v1: 22.94/25.08 with double-counted sovereign risk). H1-26 scored vs the prior FY26E stack: CV&CE +37% ahead (replacement cycle under-forecast), trading -11% (FY25 one-off treated as run-rate), group NP -34% pace (flat-28%-tax + no finance-cost line — both now modelled: ETR 41.0% actual glides to 22.5% as Iraq/Jordan losses fade). Swing factors, in order: the MNT-Halan mark (12.23/share between the two framings), the CBE path on an all-floating 43.5bn book, auto GPM (one measured year of compression carried, then cost moves with price). MC PASSES the calibration back-test with the secular drift ON (CRPS skill +3.2% non-overlapping, +9.6% monthly; zero drift FAILED) — entirely unaffected by any of this, since the engine prices the stock's own path, not the SOTP.
    ...
    files: {
      study: "files/GBCO_Valuation_Study_19-08-2026_public.docx?v=0819a",
      model: "files/GBCO_Valuation_Model_19082026_public.xlsx?v=0819a",
      pdf:   "files/GBCO_Valuation_Study_19-08-2026_public.pdf?v=0819a",
      biblio:"files/GBCO_Bibliography_19-08-2026.pdf?v=0819a"
    }
  },
  EMAARDEV: {
