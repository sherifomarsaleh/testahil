...
const TICKERS = {
  ...
  PHAR: {
    ...
    dist: {
      t20: { label:"1 month",   p5:106.97, p25:122.04, p50:131.42, p75:141.53, p95:161.41, resolve:"2026-10-06" },
      t60: { label:"3 months",  p5:97.50, p25:120.91, p50:136.46, p75:154.00, p95:190.66, resolve:"2026-12-06" }
    },
    hz: { h1:20, h3:62, l1:"1 month", l3:"3 months", cal:true },
    fit: { nu:5, cal:0.951, mult:0.9, eff:0.8559, on:"2026-09-06" },
    touch: [ /* level, P(touch) 1-month %, 3-month % - descending */
      [156.06, 12, 36], [149.56, 20, 47], [143.06, 34, 61], [136.55, 56, 77], [123.55, 58, 70], [117.05, 29, 45]
    ],
    levels: { res:[130, 135.41, 140], sup:[88.49, 85.40, 83.42] },
    tech: {
      trend: "Consolidating below the near-term moving averages, above a rising 200-day",
      summary: "The price closed 128.00 above a rising 50-day (112.27) and a rising 200-day (88.40), but below a rising 20-day (135.41). Momentum is neutral: RSI(14) is ~52 and the daily ATR near 7.58 (~5.9%) points to a volatile tape. MACD (12\u00b726\u00b79) is above zero but rolling over (+3.49 / +6.02 / \u22122.54). Over the last year it has ranged 53.10\u2013178.99; the last close sits 28% below that high and 141% above that low.",
      bull: "A daily close back above 130.00 would clear the nearest resistance; the next charted level above it is 140.00.",
      bear: "A close below 88.49 would break the nearest support; the next charted level below it is 83.42."
    },
    asof: {
  ...
  EGCH: {
    ...
    fairAsof: "2026-08-06",   // the close the FAIR VALUE is struck on — not the publication date in the filename
    ccy: "EGP",
    fair: {  bear: 0.00, base: 3.64, full: 15.47 },      // PRE-CALIBRATION. HELD BACK FROM THE SITE, DELIBERATELY. The fundamental-calibration rebuild of this name is COMPLETE and the number below is the number from BEFORE it; per instruction of 1 September 2026 nothing from the calibration campaign goes live one name at a time — the whole book publishes together at the end, in a new location, with the valuation report as a PDF and the workbook beside it. THE CALIBRATED RANGE IS DELIBERATELY NOT RESTATED HERE: it moves at every re-issue, and the three notes that used to carry it were all stale within two days (one naming a range two editions old, one naming a closing price 23% away). Read it live from engine/fv_movement.json, or with python3 engine/fv_movement.py check, which is generated from the study's own committed numbers and cannot drift from them. A FILE THAT STATES A FACT WHICH MOVES MUST NOT BE THE THING THAT REMEMBERS IT.
    dist: {
      t20: { label:"1 month",   p5:12.36, p25:13.68, p50:14.49, p75:15.34, p95:16.98, resolve:"2026-10-06" },
      t60: { label:"3 months",  p5:11.08, p25:13.45, p50:15.00, p75:16.73, p95:20.28, resolve:"2026-12-06" }
    },
    hz: { h1:20, h3:62, l1:"1 month", l3:"3 months", cal:true },
    fit: { nu:5, cal:0.951, mult:0.9, eff:0.8559, on:"2026-09-06" },
    touch: [ /* level, P(touch) 1-month %, 3-month % - descending */
      [16.78, 9, 39], [16.08, 19, 52], [15.38, 37, 68], [14.68, 69, 86], [13.28, 30, 51], [12.58, 11, 31]
    ],
    levels: { res:[14.92, 15.37, 16], sup:[13.87, 12.49, 11.13] },
    tech: {
      trend: "Trading above the whole moving-average stack, on a rising 200-day",
      summary: "The price closed 14.23 above a rising 20-day (14.08), a rising 50-day (13.48) and a rising 200-day (12.39). Momentum is neutral: RSI(14) is ~56 and the daily ATR near 0.42 (~3.0%) points to a normal tape. MACD (12\u00b726\u00b79) is positive and rising (+0.16 / +0.14 / +0.01). Over the last year it has ranged 9.77\u201315.37; the last close sits 7% below that high and 46% above that low.",
      bull: "A daily close back above 14.92 would clear the nearest resistance; the next charted level above it is 16.00.",
      bear: "A close below 13.87 would break the nearest support; the next charted level below it is 11.13."
    },
    asof: {
      mc:   { data:"2026-09-06", computed:"2026-09-06" },
      tech: { data:"2026-09-06", computed:"2026-09-07" }
  ...
  SCEM: {
    ...
    dist: {
      t20: { label:"1 month",   p5:74.31, p25:90.45, p50:101.02, p75:112.84, p95:137.29, resolve:"2026-10-06" },
      t60: { label:"3 months",  p5:60.04, p25:86.09, p50:105.42, p75:129.08, p95:184.57, resolve:"2026-12-06" }
    },
    hz: { h1:20, h3:62, l1:"1 month", l3:"3 months", cal:true },
    fit: { nu:5, cal:0.951, mult:0.963606, eff:0.916389, on:"2026-09-06" },
    touch: [ /* level, P(touch) 1-month %, 3-month % \u2014 descending */
      [95.00, 68, 80], [90.00, 45, 64], [85.00, 28, 50], [75.00, 9, 28], [70.00, 5, 20], [65.00, 3, 14]
    ],
    levels: { res:[100, 102, 113], sup:[97.47, 87.99, 67.47] },
    tech: {
      trend: "Trading above the whole moving-average stack, on a rising 200-day",
      summary: "The price closed 98.52 above a rising 20-day (97.47), a rising 50-day (81.49) and a rising 200-day (66.54). Momentum is neutral: RSI(14) is ~58 and the daily ATR near 6.00 (~6.1%) points to a volatile tape. MACD (12\u00b726\u00b79) is above zero but rolling over (+4.88 / +5.84 / \u22120.96). Over the last year it has ranged 46.30\u2013113.00; the last close sits 13% below that high and 113% above that low.",
      bull: "A daily close back above 100.00 would clear the nearest resistance; the next charted level above it is 113.00.",
      bear: "A close below 97.47 would break the nearest support; the next charted level below it is 67.47."
    },
    asof: {
      mc:   { data:"2026-09-06", computed:"2026-09-06" },
      tech: { data:"2026-09-06", computed:"2026-09-07" }
  ...
  SWDY: {
    ...
    dist: {
      t20: { label:"1 month",   p5:114.09, p25:129.63, p50:139.29, p75:149.67, p95:170.01, resolve:"2026-10-06" },
      t60: { label:"3 months",  p5:103.03, p25:127.97, p50:144.55, p75:163.27, p95:202.44, resolve:"2026-12-06" }
    },
    hz: { h1:20, h3:62, l1:"1 month", l3:"3 months", cal:true },
    fit: { nu:5, cal:0.951, mult:0.93173, eff:0.886075, on:"2026-09-06" },
    touch: [ /* level, P(touch) 1-month %, 3-month % \u2014 descending */
      [132.00, 61, 73], [120.00, 17, 34], [112.00, 7, 19], [98.00, 1, 7], [90.00, 1, 4], [80.00, 0, 2]
    ],
    levels: { res:[139.50, 150, 160], sup:[133.98, 114.58, 90.98] },
    tech: {
      trend: "Trading above the whole moving-average stack, on a rising 200-day",
      summary: "The price closed 136.20 above a rising 20-day (121.11), a rising 50-day (103.76) and a rising 200-day (86.47). Momentum is very strong: RSI(14) is ~76 and the daily ATR near 6.11 (~4.5%) points to a lively tape. MACD (12\u00b726\u00b79) is positive and rising (+8.13 / +7.75 / +0.38). Over the last year it has ranged 62.03\u2013139.50; the last close sits 2% below that high and 120% above that low.",
      bull: "A daily close back above 139.50 would clear the nearest resistance; the next charted level above it is 160.00.",
      bear: "A close below 133.98 would break the nearest support; the next charted level below it is 90.98."
    },
    asof: {
      mc:   { data:"2026-09-06", computed:"2026-09-06" },
      tech: { data:"2026-09-06", computed:"2026-09-07" }
  ...
  RMDA: {
    ...
    dist: {
      t20: { label:"1 month",   p5:5.19, p25:6.00, p50:6.51, p75:7.07, p95:8.17, resolve:"2026-09-23" },
      t60: { label:"3 months",  p5:4.66, p25:5.92, p50:6.78, p75:7.76, p95:9.85, resolve:"2026-11-23" }
    },
    hz: { h1:22, h3:62, l1:"1 month", l3:"3 months", cal:true },
    touch: [ /* descending high -> low; P(touch) 1-month %, 3-month % */
      [6.50, 80, 90], [6.00, 49, 63], [5.75, 30, 46], [5.50, 17, 33], [5.25, 10, 24], [4.75, 3, 11], [4.50, 2, 8], [4.25, 1, 5], [4.00, 1, 3]
    ],
    tech: {
      trend: "Trading above the whole moving-average stack, on a rising 200-day",
  ...
  DIB: {
    ...
    touch: [ /* descending high -> low; illustrative only, calibration FAILED */
      [8.88, 0, 6], [10.20, 0, 0], [8.63, 1, 10], [7.76, 28, 53], [7.59, 51, 70], [7.40, 100, 100], [7.09, 37, 64]
    ],
    levels: { res:[7.70, 9.33, 9.94], sup:[7.21, 6.91, 6.08] },
    tech: {
      trend: "Trading below the whole moving-average stack, under a falling 200-day",
  ...
  EXTRA: {
    ...
    dist: {
      t20: { label:"1 month",   p5:57.85, p25:61.94, p50:64.71, p75:67.65, p95:72.44, resolve:"2026-09-30" },
      t60: { label:"3 months",  p5:51.68, p25:59.17, p50:64.47, p75:70.24, p95:80.60, resolve:"2026-11-30" }
    },
    hz: { h1:21, h3:63, l1:"1 month", l3:"3 months", cal:true },
    fit: { nu:12, cal:1.063, mult:1, eff:1.063, on:"2026-09-01" },
    touch: [ /* descending high -> low */
      [81.70, 0, 7], [74.90, 3, 23], [71.50, 12, 40], [64.70, 82, 90], [61.30, 33, 61], [54.50, 1, 17]
    ],
    levels: { res:[79.31, 83.97, 87.87], sup:[64, 62.50, 61] },
    tech: {
      trend: "Trading below the whole moving-average stack, under a falling 200-day",
      summary: "The price closed 65.25 below a falling 20-day (65.76), a falling 50-day (68.29) and a falling 200-day (79.80). Momentum is neutral: RSI(14) is ~43 and the daily ATR near 1.18 (~1.8%) points to a normal tape. MACD (12\u00b726\u00b79) is below zero but turning up (\u22120.68 / \u22121.05 / +0.37). Over the last year it has ranged 62.50\u201393.50; the last close sits 30% below that high and 4% above that low.",
      bull: "A daily close back above 79.31 would clear the nearest resistance; the next charted level above it is 87.87.",
      bear: "A close below 64.00 would break the nearest support; the next charted level below it is 61.00."
    },
    asof: {
      mc:   { data:"2026-08-31", computed:"2026-09-01" },
      tech: { data:"2026-08-31", computed:"2026-09-07" }
  ...
  EMAARDEV: {
    ...
    dist: {
      t20: { label:"1 month",   p5:11.08, p25:12.08, p50:12.68, p75:13.32, p95:14.55, resolve:"2026-09-28" },
      t60: { label:"3 months",  p5:9.73, p25:11.44, p50:12.52, p75:13.69, p95:16.15, resolve:"2026-11-27" }
    },
    hz: { h1:22, h3:64, l1:"1 month", l3:"3 months", cal:true },
    fit: { nu:4.5, cal:0.965, mult:1, eff:0.965, on:"2026-08-30" },
    touch: [ /* descending high -> low; P(touch) 1-month %, 3-month % */
      [18.00, 0, 3], [17.00, 1, 6], [16.00, 2, 10], [15.00, 5, 19], [14.00, 17, 40], [13.00, 67, 80], [12.00, 37, 64]
    ],
    levels: { res:[12.97, 14.34, 15.41], sup:[12.02, 11.53, 11] },
    tech: {
      trend: "Trading below the whole moving-average stack, under a falling 200-day",
  ...
  RAYA: {
    ...
    dist: {
      t20: { label:"1 month",   p5:6.17, p25:6.85, p50:7.26, p75:7.71, p95:8.56, resolve:"2026-09-23" },
      t60: { label:"3 months",  p5:5.67, p25:6.83, p50:7.58, p75:8.42, p95:10.13, resolve:"2026-11-23" }
    },
    hz: { h1:22, h3:62, l1:"1 month", l3:"3 months", cal:true },
    touch: [ /* descending high -> low */
      [10.01, 1, 9], [8.85, 4, 25], [8.09, 18, 51], [7.31, 71, 87], [6.54, 24, 42], [5.39, 1, 7]
    ],
    levels: { res:[7.30, 7.66, 7.81], sup:[6.94, 6.02, 5.03] },
    tech: {
      trend: "Consolidating below the near-term moving averages, above a rising 200-day",
  ...
  ORWE: {
    ...
    dist: {
      t20: { label:"1 month",   p5:22.99, p25:25.11, p50:26.38, p75:27.73, p95:30.29, resolve:"2026-09-23" },
      t60: { label:"3 months",  p5:21.35, p25:24.94, p50:27.21, p75:29.70, p95:34.65, resolve:"2026-11-23" }
    },
    hz: { h1:22, h3:62, l1:"1 month", l3:"3 months", cal:true },
    touch: [ /* descending high -> low */
      [26.81, 66, 84], [24.57, 32, 50], [23.46, 13, 29], [21.22, 2, 9], [20.11, 1, 5], [17.87, 0, 2]
    ],
  ...
  LCSW: {
    ...
    dist: {
      t20: { label:"1 month",   p5:27.71, p25:32.47, p50:35.47, p75:38.79, p95:45.46, resolve:"2026-09-23" },
      t60: { label:"3 months",  p5:23.92, p25:31.59, p50:36.93, p75:43.17, p95:56.88, resolve:"2026-11-23" }
    },
    hz: { h1:22, h3:62, l1:"1 month", l3:"3 months", cal:true },
    touch: [ /* descending high -> low */
      [36.80, 63, 81], [33.90, 72, 82], [31.50, 35, 54], [28.90, 14, 32], [26.50, 5, 18], [24.40, 2, 11], [22.10, 1, 6]
    ],
    levels: { res:[35, 36.74, 37.79], sup:[31.52, 28.38, 23.34] },
    tech: {
      trend: "Trading above the whole moving-average stack, on a rising 200-day",
  ...
  TMGH: {
    ...
    dist: {
      t20: { label:"1 month",   p5:86.73, p25:95.00, p50:99.95, p75:105.22, p95:115.25, resolve:"2026-09-23" },
      t60: { label:"3 months",  p5:80.50, p25:94.74, p50:103.82, p75:113.76, p95:133.71, resolve:"2026-11-23" }
    },
    hz: { h1:22, h3:62, l1:"1 month", l3:"3 months", cal:true },
    touch: [ /* descending high → low — same absolute levels, reprobabilised on the 19 Jul cycle-2 paths */
      [126.00, 2, 14], [118.00, 5, 27], [110.00, 18, 50], [100.00, 76, 89], [88.00, 12, 28], [83.00, 4, 14]
    ],
    levels: { res:[100.12, 102, 103.87], sup:[92.39, 80.96, 74.19] },
    tech: {
      trend: "Consolidating below the near-term moving averages, above a rising 200-day",
  ...
  COMI: {
    ...
    dist: {
      t20: { label:"1 month",   p5:127.12, p25:136.18, p50:141.55, p75:147.14, p95:157.60, resolve:"2026-10-01" },
      t60: { label:"3 months",  p5:119.70, p25:136.21, p50:146.47, p75:157.50, p95:179.05, resolve:"2026-12-01" }
    },
    hz: { h1:20, h3:62, l1:"1 month", l3:"3 months", cal:true },
    fit: { nu:5, cal:0.958, mult:0.982277, eff:0.941022, on:"2026-09-01" },
    touch: [ /* descending high -> low — same absolute levels, reprobabilised on the 28-Jul cycle-3 paths */
      [150.00, 24, 60], [140.00, 86, 94], [135.00, 42, 59], [120.00, 2, 11], [110.00, 0, 4], [100.00, 0, 1]
    ],
    levels: { res:[143.34, 150, 160], sup:[137.30, 132.88, 126.58] },
    tech: {
      trend: "Consolidating below the near-term moving averages, above a rising 200-day",
      summary: "The price closed 139.00 above a rising 50-day (136.87) and a rising 200-day (125.85), but below a falling 20-day (139.03). Momentum is neutral: RSI(14) is ~52 and the daily ATR near 2.45 (~1.8%) points to a normal tape. MACD (12\u00b726\u00b79) is above zero but rolling over (+0.17 / +0.44 / \u22120.28). Over the last year it has ranged 84.64\u2013145.01; the last close sits 4% below that high and 64% above that low.",
      bull: "A daily close back above 143.34 would clear the nearest resistance; the next charted level above it is 160.00.",
  ...
  KAKAO: {
    ...
    dist: {
      t20: { label:"1 month",   p5:29254, p25:33603, p50:36588, p75:39843, p95:45839, resolve:"2026-10-01" },
      t60: { label:"3 months",  p5:24884, p25:31750, p50:36839, p75:42708, p95:54434, resolve:"2026-12-01" }
    },
    hz: { h1:20, h3:61, l1:"1 month", l3:"3 months", cal:true },
    fit: { nu:8, cal:1.035, mult:1, eff:1.035, on:"2026-09-01" },
    touch: [ /* descending high -> low */
      [44000, 13, 37], [40000, 40, 63], [37000, 81, 89], [32000, 25, 49], [28000, 5, 21], [24000, 1, 7]
    ],
    levels: { res:[38477, 39979, 41450], sup:[34650, 33472, 32384] },
    tech: {
      trend: "Mixed against the moving-average stack, below a falling 200-day",
      summary: "The price closed 36500 below a rising 20-day (37920) and a falling 200-day (48662), but above a falling 50-day (36376). Momentum is neutral: RSI(14) is ~46 and the daily ATR near 1790 (~4.9%) points to a lively tape. MACD (12\u00b726\u00b79) is negative and still falling (\u2212258 / \u221215 / \u2212243). Over the last year it has ranged 32250\u201369700; the last close sits 48% below that high and 13% above that low.",
  ...
  ALDAR: {
    ...
    dist: {
      t20: { label:"1 month",   p5:6.82, p25:7.31, p50:7.65, p75:8.00, p95:8.59, resolve:"2026-09-21" },
      t60: { label:"3 months",  p5:6.07, p25:6.94, p50:7.54, p75:8.19, p95:9.35, resolve:"2026-11-23" }
    },
    hz: { h1:21, h3:64, l1:"1 month", l3:"3 months", cal:true },
    touch: [ /* descending high -> low */
      [9.90, 0, 4], [9.50, 1, 8], [9.00, 2, 16], [8.60, 8, 29], [8.00, 45, 65], [7.50, 64, 81], [7.00, 15, 46]
    ],
    levels: { res:[7.78, 8.04, 9.22], sup:[7.60, 7.47, 7.08] },
    tech: {
      trend: "Mixed against the moving-average stack, below a falling 200-day",
  ...
  OIH: {
    ...
    dist: {
      t20: { label:"1 month",   p5:1.57, p25:1.79, p50:1.92, p75:2.06, p95:2.34, resolve:"2026-09-23" },
      t60: { label:"3 months",  p5:1.39, p25:1.75, p50:1.99, p75:2.26, p95:2.84, resolve:"2026-11-23" }
    },
    hz: { h1:22, h3:62, l1:"1 month", l3:"3 months", cal:true },
    touch: [ /* descending high → low; P(touch) 1-month %, 3-month % */
      [1.80, 53, 69], [1.60, 11, 28], [1.50, 5, 17], [1.30, 1, 6], [1.20, 0, 3], [1.10, 0, 2]
    ],
  ...
  ORAS: {
    ...
    dist: {
      t20: { label:"1 month",   p5:671.62, p25:754.33, p50:804.74, p75:859.28, p95:965.02, resolve:"2026-09-23" },
      t60: { label:"3 months",  p5:615.97, p25:751.65, p50:840.65, p75:940.16, p95:1145.51, resolve:"2026-11-23" }
    },
    hz: { h1:22, h3:62, l1:"1 month", l3:"3 months", cal:true },
    touch: [ /* descending high → low; P(touch) 1-month %, 3-month % */
      [850.00, 43, 71], [800.00, 80, 90], [760.00, 58, 70], [680.00, 11, 25], [640.00, 4, 15], [600.00, 2, 8]
    ],
    levels: { res:[799.99, 812.50, 830], sup:[720.80, 705.25, 681.76] },
    tech: {
      trend: "Trading above the whole moving-average stack, on a rising 200-day",
  ...
  ARAMCO: {
    ...
    dist: {
      t20: { label:"1 month",   p5:24.56, p25:25.55, p50:26.22, p75:26.91, p95:28.00, resolve:"2026-09-30" },
      t60: { label:"3 months",  p5:23.44, p25:25.24, p50:26.47, p75:27.75, p95:29.89, resolve:"2026-11-30" }
    },
    hz: { h1:21, h3:63, l1:"1 month", l3:"3 months", cal:true },
    fit: { nu:15, cal:1.056, mult:1, eff:1.056, on:"2026-09-01" },
    touch: [ /* descending high -> low */
      [30.00, 0, 7], [29.00, 1, 17], [28.00, 8, 35], [27.00, 35, 64], [25.00, 19, 44], [24.00, 3, 18], [23.00, 0, 6]
    ],
    levels: { res:[26.48, 26.90, 27.96], sup:[25, 24.30, 23.04] },
    tech: {
      trend: "Trading below the whole moving-average stack, under a flat 200-day",
      summary: "The price closed 26.06 below a falling 20-day (26.48), a falling 50-day (26.49) and a flat 200-day (26.10). Momentum is soft: RSI(14) is ~39 and the daily ATR near 0.24 (~0.9%) points to an orderly tape. MACD (12\u00b726\u00b79) is negative and still falling (\u22120.13 / \u22120.08 / \u22120.05). Over the last year it has ranged 23.04\u201327.96; the last close sits 7% below that high and 13% above that low.",
      bull: "A daily close back above 26.48 would clear the nearest resistance; the next charted level above it is 27.96.",
      bear: "A close below 25.00 would break the nearest support; the next charted level below it is 23.04."
    },
    asof: {
      mc:   { data:"2026-08-31", computed:"2026-09-01" },
      tech: { data:"2026-08-31", computed:"2026-09-07" }
  ...
  SABIC: {
    ...
    dist: {
      t20: { label:"1 month",   p5:45.85, p25:48.35, p50:50.04, p75:51.82, p95:54.66, resolve:"2026-10-01" },
      t60: { label:"3 months",  p5:42.50, p25:47.04, p50:50.21, p75:53.58, p95:59.34, resolve:"2026-12-01" }
    },
    hz: { h1:21, h3:63, l1:"1 month", l3:"3 months", cal:true },
    fit: { nu:15, cal:1.056, mult:1, eff:1.056, on:"2026-09-01" },
    touch: [ /* descending high -> low */
      [58.00, 1, 13], [56.00, 3, 24], [54.00, 12, 41], [52.00, 39, 66], [50.00, 86, 91], [48.00, 35, 60], [46.00, 9, 34]
    ],
    levels: { res:[53.87, 58.97, 61.71], sup:[49.15, 48.20, 47] },
    tech: {
      trend: "Trading below the whole moving-average stack, under a falling 200-day",
      summary: "The price closed 50.10 below a falling 20-day (50.19), a falling 50-day (51.24) and a falling 200-day (55.05). Momentum is neutral: RSI(14) is ~46 and the daily ATR near 0.72 (~1.4%) points to an orderly tape. MACD (12\u00b726\u00b79) is below zero but turning up (\u22120.41 / \u22120.51 / +0.10). Over the last year it has ranged 48.20\u201364.00; the last close sits 22% below that high and 4% above that low.",
      bull: "A daily close back above 53.87 would clear the nearest resistance; the next charted level above it is 61.71.",
      bear: "A close below 49.15 would break the nearest support; the next charted level below it is 47.00."
    },
    asof: {
      mc:   { data:"2026-09-01", computed:"2026-09-01" },
      tech: { data:"2026-09-01", computed:"2026-09-07" }
  ...
  MAADEN: {
    ...
    dist: {
      t20: { label:"1 month",   p5:56.85, p25:62.56, p50:66.54, p75:70.82, p95:77.96, resolve:"2026-09-30" },
      t60: { label:"3 months",  p5:51.07, p25:60.41, p50:67.22, p75:74.75, p95:88.68, resolve:"2026-11-30" }
    },
    hz: { h1:21, h3:63, l1:"1 month", l3:"3 months", cal:true },
    fit: { nu:12, cal:1.056, mult:1, eff:1.056, on:"2026-09-01" },
    touch: [ /* descending high -> low */
      [80.00, 5, 24], [72.00, 32, 58], [66.00, 86, 91], [62.00, 39, 60], [58.00, 12, 34], [54.00, 3, 17], [50.00, 1, 7], [46.00, 0, 3]
    ],
  ...
  ADNOCGAS: {
    ...
    hz: { h1:21, h3:64, l1:"1 month", l3:"3 months", cal:true },
    touch: [ /* descending high -> low; P(touch) 1-month %, 3-month % */
      [3.90, 0, 5], [3.75, 1, 12], [3.65, 2, 21], [3.55, 8, 35], [3.35, 63, 81], [3.25, 61, 78], [3.15, 21, 50]
    ],
  ...
  RIBL: {
    ...
    dist: {
      t20: { label:"1 month",   p5:19.17, p25:20.24, p50:20.97, p75:21.73, p95:22.95, resolve:"2026-09-30" },
      t60: { label:"3 months",  p5:17.90, p25:19.81, p50:21.12, p75:22.51, p95:24.95, resolve:"2026-11-30" }
    },
    hz: { h1:21, h3:63, l1:"1 month", l3:"3 months", cal:true },
    fit: { nu:12, cal:1.063, mult:1, eff:1.063, on:"2026-09-01" },
    touch: [ /* descending high -> low */
      [23.26, 5, 27], [22.25, 21, 51], [21.24, 68, 83], [19.22, 9, 32], [18.21, 1, 13], [17.20, 0, 4]
    ],
    levels: { res:[21.44, 22.41, 24.01], sup:[20.57, 20.16, 19.61] },
    tech: {
      trend: "Trading above the whole moving-average stack, on a flat 200-day",
      summary: "The price closed 20.90 above a flat 20-day (20.50), a flat 50-day (20.49) and a flat 200-day (20.59). Momentum is neutral: RSI(14) is ~57 and the daily ATR near 0.27 (~1.3%) points to an orderly tape. MACD (12\u00b726\u00b79) is positive and rising (+0.11 / +0.04 / +0.06). Over the last year it has ranged 18.98\u201322.41; the last close sits 7% below that high and 10% above that low.",
      bull: "A daily close back above 21.44 would clear the nearest resistance; the next charted level above it is 24.01.",
      bear: "A close below 20.57 would break the nearest support; the next charted level below it is 19.61."
    },
    asof: {
      mc:   { data:"2026-08-31", computed:"2026-09-01" },
      tech: { data:"2026-08-31", computed:"2026-09-07" }
  ...
  ENBD: {
    ...
    dist: {
      t20: { label:"1 month",   p5:27.12, p25:29.61, p50:31.08, p75:32.67, p95:35.74, resolve:"2026-09-28" },
      t60: { label:"3 months",  p5:24.57, p25:28.73, p50:31.31, p75:34.11, p95:39.99, resolve:"2026-11-27" }
    },
    hz: { h1:22, h3:64, l1:"1 month", l3:"3 months", cal:true },
    fit: { nu:4.5, cal:0.965, mult:1, eff:0.965, on:"2026-08-30" },
    touch: [ /* descending high -> low; P(touch) 1-month %, 3-month % */
      [37.00, 4, 19], [35.00, 12, 34], [33.00, 35, 59], [31.00, 100, 100], [30.00, 55, 72], [29.00, 30, 52], [27.00, 8, 25]
    ],
    levels: { res:[31.26, 31.81, 37.40], sup:[27.80, 24.14, 20.40] },
    tech: {
      trend: "Consolidating below the near-term moving averages, above a rising 200-day",
  ...
  FAB: {
    ...
    dist: {
      t20: { label:"1 month",   p5:17.67, p25:18.95, p50:19.69, p75:20.49, p95:22.01, resolve:"2026-09-28" },
      t60: { label:"3 months",  p5:16.29, p25:18.49, p50:19.83, p75:21.26, p95:24.20, resolve:"2026-11-27" }
    },
    hz: { h1:22, h3:64, l1:"1 month", l3:"3 months", cal:true },
    fit: { nu:4.5, cal:0.965, mult:1, eff:0.965, on:"2026-08-30" },
    touch: [ /* descending high -> low; P(touch) 1-month %, 3-month % */
      [20.00, 68, 82], [19.00, 47, 66], [18.50, 26, 49], [18.00, 13, 34], [17.00, 3, 16], [16.00, 1, 7], [15.00, 0, 3]
    ],
  ...
  ACWA: {
    ...
    dist: {
      t20: { label:"1 month",   p5:162.61, p25:179.85, p50:191.89, p75:204.90, p95:226.70, resolve:"2026-09-30" },
      t60: { label:"3 months",  p5:142.21, p25:171.34, p50:192.87, p75:217.00, p95:262.27, resolve:"2026-11-30" }
    },
    hz: { h1:21, h3:63, l1:"1 month", l3:"3 months", cal:true },
    fit: { nu:12, cal:1.063, mult:1, eff:1.063, on:"2026-09-01" },
    touch: [ /* descending high -> low; P(touch) 1-month %, 3-month % */
      [250.00, 1, 14], [230.00, 6, 29], [210.00, 30, 57], [195.00, 77, 87], [180.00, 44, 66], [165.00, 10, 35], [150.00, 2, 15]
    ],
    levels: { res:[193.90, 201.32, 207.57], sup:[183.98, 174.82, 166.87] },
    tech: {
      trend: "Trading above the whole moving-average stack, on a falling 200-day",
      summary: "The price closed 191.90 above a flat 20-day (190.04), a falling 50-day (191.03) and a falling 200-day (184.61). Momentum is neutral: RSI(14) is ~52 and the daily ATR near 4.40 (~2.3%) points to a normal tape. MACD (12\u00b726\u00b79) is positive and rising (+0.95 / +0.16 / +0.79). Over the last year it has ranged 149.40\u2013252.60; the last close sits 24% below that high and 28% above that low.",
      bull: "A daily close back above 193.90 would clear the nearest resistance; the next charted level above it is 207.57.",
      bear: "A close below 183.98 would break the nearest support; the next charted level below it is 166.87."
    },
    asof: {
      mc:   { data:"2026-08-31", computed:"2026-09-01" },
      tech: { data:"2026-08-31", computed:"2026-09-07" }
  ...
  PRDC: {
    ...
    dist: {
      t20: { label:"1 month",   p5:8.10, p25:9.29, p50:10.04, p75:10.85, p95:12.45, resolve:"2026-09-23" },
      t60: { label:"3 months",  p5:7.38, p25:9.27, p50:10.53, p75:11.97, p95:15.01, resolve:"2026-11-23" }
    },
    hz: { h1:22, h3:62, l1:"1 month", l3:"3 months", cal:true },
    touch: [ /* level, P(touch) 1-month %, 3-month % — descending */
      [10.76, 41, 68], [9.94, 81, 90], [9.11, 41, 56], [8.69, 22, 38], [7.87, 6, 17], [7.45, 3, 11], [6.62, 1, 5]
    ],
    levels: { res:[9.80, 10, 10.40], sup:[9.03, 8.70, 8.52] },
    tech: {
      trend: "Trading above the whole moving-average stack, on a rising 200-day",
...
const BANDS = {
  ...
  ACWA: {mkt:"SA", n:15, hits:13, c50:0.4000, c80:0.8000, c90:0.8667, width:0.909, strength:"market-only", flag:null},
  ...
  COMI: {mkt:"EG", n:57, hits:52, c50:0.4912, c80:0.8596, c90:0.9123, width:1.271, strength:"long", flag:null},
  ...
  PHAR: {mkt:"EG", n:56, hits:56, c50:0.5536, c80:0.9643, c90:1.0000, width:1.447, strength:"long", flag:"wide"},
  ...
  SABIC: {mkt:"SA", n:58, hits:53, c50:0.4828, c80:0.7759, c90:0.9138, width:1.037, strength:"long", flag:null},
  ...
  SCEM: {mkt:"EG", n:57, hits:53, c50:0.7018, c80:0.8596, c90:0.9298, width:1.382, strength:"long", flag:null},
  ...
  SWDY: {mkt:"EG", n:57, hits:54, c50:0.5263, c80:0.8070, c90:0.9474, width:1.371, strength:"long", flag:null},
...
const LEDGER = [
  ...
  // ---- SCEM · equity (EGX Egypt) · cycle 1 (6 Aug 2026 published study); 5-year gate-(d) back-test FAILS (−0.1482, non-uniform PIT) on OVER-COVERAGE driven by a 29.3% flat-close frequency) ----
  {
    ...
    realized_close:98.52, realized_high:113, realized_low:79,
    in_90:true, in_50:false, realized_quantile:0.885, median_err:0.2289, touch_hit:{ "+5":true, "+10":true, "+15":true, "+20":true, "-5":false, "-10":false },
    reanchor_from:null
  },
  {
    instrument:"SCEM", asset_class:"equity",
  ...
  // ---- SWDY · equity (EGX Egypt) · cycle 1 (5 Aug 2026 published study) ----
  {
    ...
    realized_close:136.2, realized_high:139.5, realized_low:105.2,
    in_90:false, in_50:false, realized_quantile:null, median_err:0.2767, touch_hit:{ "+5":true, "+10":true, "+15":true, "+20":true, "-5":false, "-10":false },
    reanchor_from:null
  },
  {
    instrument:"SWDY", asset_class:"equity",
  ...
  // ---- EMAARDEV · other (DFM UAE) · cycle 1 (8 Jul 2026 published study) ----
  ...
  },
  {
    ...
    realized_close:4602.15, realized_high:4697.1, realized_low:3996.05,
    in_90:false, in_50:false, realized_quantile:null, median_err:0.1219,
    touch_hit:{ "+5":true, "+10":true, "+15":false, "+20":false, "-5":false, "-10":false }
  ,
  ...
  },
  {
    ...
    realized_close:196.8, realized_high:202.2, realized_low:181.5,
    in_90:true, in_50:true, realized_quantile:0.593, median_err:0.0263,
  ...
  },
  {
    ...
    realized_close:23.34, realized_high:23.72, realized_low:20.8,
    in_90:true, in_50:false, realized_quantile:0.836, median_err:0.0958,
    touch_hit:{ "+5":true, "+10":true, "+15":false, "+20":false, "-5":false, "-10":false }
  },
  {
    instrument:"ADIBUAE", asset_class:"equity",
  ...
  },
  {
    ...
    realized_close:3.35, realized_high:3.43, realized_low:3.17,
    in_90:true, in_50:true, realized_quantile:0.733, median_err:0.0436,
    touch_hit:{ "+5":true, "+10":false, "+15":false, "+20":false, "-5":false, "-10":false }
  },
  {
    instrument:"AGTHIA", asset_class:"equity",
  ...
  },
  {
    ...
    realized_close:7.7, realized_high:8.05, realized_low:7.38,
    in_90:true, in_50:true, realized_quantile:0.542, median_err:0.0092,
    touch_hit:{ "+5":true, "+10":false, "+15":false, "+20":false, "-5":false, "-10":false }
  },
  {
    instrument:"ALDAR", asset_class:"equity",
  ...
  },
  {
    ...
    realized_close:26.1, realized_high:27.26, realized_low:26.04,
    in_90:true, in_50:true, realized_quantile:0.316, median_err:-0.0217,
    touch_hit:{ "+5":false, "+10":false, "+15":false, "+20":false, "-5":false, "-10":false }
  },
  {
    instrument:"ARAMCO", asset_class:"equity",
  ...
  },
  {
    ...
    realized_close:2.7, realized_high:2.83, realized_low:2.67,
    in_90:true, in_50:true, realized_quantile:0.545, median_err:0.0075,
    touch_hit:{ "+5":true, "+10":false, "+15":false, "+20":false, "-5":false, "-10":false }
  },
  {
    instrument:"DEWA", asset_class:"equity",
  ...
  },
  {
    ...
    touch:{ "+5":48, "+10":21, "+15":8, "+20":3, "-5":43, "-10":16 },
    realized_close:13, realized_high:14, realized_low:12.9,
    in_90:true, in_50:true, realized_quantile:0.429, median_err:-0.0152,
    touch_hit:{ "+5":true, "+10":false, "+15":false, "+20":false, "-5":false, "-10":false }
  },
  {
    instrument:"EMAARDEV", asset_class:"equity",
  ...
  },
  {
    ...
    realized_close:30.64, realized_high:32.36, realized_low:29.24,
    in_90:true, in_50:true, realized_quantile:0.544, median_err:0.0109,
    touch_hit:{ "+5":true, "+10":false, "+15":false, "+20":false, "-5":false, "-10":false }
  },
  {
    instrument:"ENBD", asset_class:"equity",
  ...
  },
  {
    ...
    realized_close:66.25, realized_high:69.2, realized_low:62.5,
    in_90:true, in_50:true, realized_quantile:0.279, median_err:-0.0358,
    touch_hit:{ "+5":false, "+10":false, "+15":false, "+20":false, "-5":true, "-10":false }
  },
  {
    instrument:"EXTRA", asset_class:"equity",
  ...
  },
  {
    ...
    realized_close:19.76, realized_high:20.16, realized_low:18.54,
    in_90:true, in_50:false, realized_quantile:0.764, median_err:0.0561,
    touch_hit:{ "+5":true, "+10":false, "+15":false, "+20":false, "-5":false, "-10":false }
  },
  {
    instrument:"FAB", asset_class:"equity",
  ...
  },
  {
    ...
    realized_close:34.66, realized_high:37.79, realized_low:30.2,
    in_90:true, in_50:true, realized_quantile:0.524, median_err:0.0096,
    touch_hit:{ "+5":true, "+10":true, "+15":false, "+20":false, "-5":true, "-10":true }
  },
  {
    instrument:"LCSW", asset_class:"equity",
  ...
  },
  {
    ...
    realized_close:1.88, realized_high:1.93, realized_low:1.43,
    in_90:false, in_50:false, realized_quantile:null, median_err:0.2617,
    touch_hit:{ "+5":true, "+10":true, "+15":true, "+20":true, "-5":false, "-10":false }
  },
  {
    instrument:"OIH", asset_class:"equity",
  ...
  },
  {
    ...
    realized_close:782.25, realized_high:799.99, realized_low:685,
    in_90:true, in_50:false, realized_quantile:0.798, median_err:0.0802,
    touch_hit:{ "+5":true, "+10":true, "+15":false, "+20":false, "-5":false, "-10":false }
  },
  {
    instrument:"ORAS", asset_class:"equity",
  ...
  },
  {
    ...
    realized_close:26, realized_high:27.41, realized_low:22.55,
    in_90:true, in_50:false, realized_quantile:0.926, median_err:0.1083,
    touch_hit:{ "+5":true, "+10":true, "+15":true, "+20":false, "-5":false, "-10":false }
  },
  {
    instrument:"ORWE", asset_class:"equity",
  ...
  },
  {
    ...
    realized_close:9.69, realized_high:9.85, realized_low:8.7,
    in_90:true, in_50:true, realized_quantile:0.423, median_err:-0.0261,
    touch_hit:{ "+5":false, "+10":false, "+15":false, "+20":false, "-5":true, "-10":true }
  },
  {
    instrument:"PRDC", asset_class:"equity",
  ...
  },
  {
    ...
    realized_close:7.07, realized_high:7.79, realized_low:6.95,
    in_90:true, in_50:false, realized_quantile:0.182, median_err:-0.1028,
    touch_hit:{ "+5":false, "+10":false, "+15":false, "+20":false, "-5":true, "-10":true }
  },
  {
    instrument:"RAYA", asset_class:"equity",
  ...
  },
  {
    ...
    realized_close:21.06, realized_high:21.12, realized_low:19.6,
    in_90:true, in_50:true, realized_quantile:0.525, median_err:0.0038,
    touch_hit:{ "+5":false, "+10":false, "+15":false, "+20":false, "-5":true, "-10":false }
  },
  {
    instrument:"RIBL", asset_class:"equity",
  ...
  },
  {
    ...
    realized_close:6.35, realized_high:7.39, realized_low:4.98,
    in_90:false, in_50:false, realized_quantile:null, median_err:0.2574,
    touch_hit:{ "+5":true, "+10":true, "+15":true, "+20":true, "-5":false, "-10":false }
  },
  {
    instrument:"RMDA", asset_class:"equity",
  ...
  },
  {
    ...
    realized_close:50.35, realized_high:52.65, realized_low:49.1,
    in_90:true, in_50:false, realized_quantile:0.236, median_err:-0.0393,
    touch_hit:{ "+5":false, "+10":false, "+15":false, "+20":false, "-5":true, "-10":false }
  },
  {
    instrument:"SABIC", asset_class:"equity",
  ...
  },
  {
    ...
    touch:{ "+5":52, "+10":25, "+15":11, "+20":5, "-5":38, "-10":14 },
    realized_close:97.8, realized_high:101.3, realized_low:95.2,
    in_90:true, in_50:true, realized_quantile:0.303, median_err:-0.0412,
    touch_hit:{ "+5":false, "+10":false, "+15":false, "+20":false, "-5":true, "-10":false }
  },
  {
    instrument:"TMGH", asset_class:"equity",
  ...
  //      Kakao/LGES first roll-forward since their 28-Jun studies. ----
  {
    ...
    realized_close:138.1, realized_high:142.88, realized_low:135.35,
    in_90:true, in_50:true, realized_quantile:0.252, median_err:-0.0418,
    touch_hit:{ "+5":false, "+10":false, "+15":false, "+20":false, "-5":false, "-10":false }
  },
  {
    instrument:"COMI", asset_class:"equity",
...
,
  ...
  { instrument:"EGCH", asset_class:"equity", anchor_date:"2026-08-06", run_date:"2026-08-06", anchor_price:13.98, ccy:"EGP",
    ...
    touch:{ "+5":56, "+10":30, "+15":15, "+20":7, "-5":44, "-10":18 },
    realized_close:14.23, realized_high:14.87, realized_low:13.3, in_90:true, in_50:true, realized_quantile:0.511, median_err:0.0028,
    touch_hit:{ "+5":true, "+10":false, "+15":false, "+20":false, "-5":false, "-10":false },
    reanchor_from:null },
  { instrument:"EGCH", asset_class:"equity", anchor_date:"2026-08-06", run_date:"2026-08-06", anchor_price:13.98, ccy:"EGP",
  ...
  { instrument:"PHAR", asset_class:"equity", anchor_date:"2026-08-06", run_date:"2026-08-06", anchor_price:130.05, ccy:"EGP",
    ...
    realized_close:128, realized_high:178.99, realized_low:124.5, in_90:true, in_50:true, realized_quantile:0.417, median_err:-0.0280,
    touch_hit:{ "+5":true, "+10":true, "+15":true, "+20":true, "-5":false, "-10":false },
    reanchor_from:null },
  { instrument:"PHAR", asset_class:"equity", anchor_date:"2026-08-06", run_date:"2026-08-06", anchor_price:130.05, ccy:"EGP",
    horizon_label:"3 months", grade_date:"2026-11-08", grade_basis:"projected", horizon_days:62, cycle_no:1,
  ...
  //      latest library close. Append-only.
  {
    ...
    horizon_label:"1 month", grade_date:"2026-09-23", grade_basis:"projected", horizon_days:22,
    cycle_no:3, reanchor_from:"2026-07-22", anchor_vol:0.4871,
  ...
  },
  {
    ...
    anchor_date:"2026-08-23", run_date:"2026-08-24", anchor_price:17.71, ccy:"EGP",
    horizon_label:"3 months", grade_date:"2026-11-23", grade_basis:"projected", horizon_days:62,
    cycle_no:3, reanchor_from:"2026-07-22", anchor_vol:0.5047,
  ...
  // ---- 24-Aug-2026 single-name roll-forward: LCSW, struck on its own
  //      latest library close. Append-only.
  {
    instrument:"LCSW", asset_class:"equity",
    anchor_date:"2026-08-23", run_date:"2026-08-24", anchor_price:34.66, ccy:"EGP",
    horizon_label:"1 month", grade_date:"2026-09-23", grade_basis:"projected", horizon_days:22,
    cycle_no:3, reanchor_from:"2026-07-21", anchor_vol:0.6163,
    signal_z:0.8944, signal_alpha:0.008842,
    note:"Cycle 3 roll-forward, 24-Aug-2026 — struck on the 23-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-23 and is graded in this same pass. The previous cone was anchored 2026-07-21; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) EG live fit nu=5.0, width_cal=0.951. PER-NAME WIDTH OVERLAY APPLIED (engine/adaptive_width.py): this name has cleared the 28-window history gate, so live_width_mult() returns 0.9207 on its OWN resolved 3-month residuals and the cone was simulated at an effective width_cal of 0.8755, not the pooled 0.951. It is an OVERLAY, NOT A REFIT: the pooled (nu, width_cal), the carry drift and the tail nu are untouched by it. rf_live 19.50% CBE main operation rate. Direction call UP, from this name’s own mom_combo z of +0.894 (outside the 0.25 dead zone); tilt +0.89% at 1M and +1.71% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on EG’s own realized calendar — a calendar commitment, not a session count; the session counts (h=22 / 62) size the cone only.",
    p5:27.71, p25:32.47, p50:35.47, p75:38.79, p95:45.46,
    touch:{ "+5":68, "+10":47, "+15":31, "+20":20, "-5":55, "-10":31 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  {
    ...
    anchor_date:"2026-08-23", run_date:"2026-08-24", anchor_price:34.66, ccy:"EGP",
    horizon_label:"3 months", grade_date:"2026-11-23", grade_basis:"projected", horizon_days:62,
    cycle_no:3, reanchor_from:"2026-07-21", anchor_vol:0.6425,
    signal_z:0.8944, signal_alpha:0.01697,
    note:"Cycle 3 roll-forward, 24-Aug-2026 — struck on the 23-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-23 and is graded in this same pass. The previous cone was anchored 2026-07-21; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) EG live fit nu=5.0, width_cal=0.951. PER-NAME WIDTH OVERLAY APPLIED (engine/adaptive_width.py): this name has cleared the 28-window history gate, so live_width_mult() returns 0.9207 on its OWN resolved 3-month residuals and the cone was simulated at an effective width_cal of 0.8755, not the pooled 0.951. It is an OVERLAY, NOT A REFIT: the pooled (nu, width_cal), the carry drift and the tail nu are untouched by it. rf_live 19.50% CBE main operation rate. Direction call UP, from this name’s own mom_combo z of +0.894 (outside the 0.25 dead zone); tilt +0.89% at 1M and +1.71% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on EG’s own realized calendar — a calendar commitment, not a session count; the session counts (h=22 / 62) size the cone only.",
    p5:23.92, p25:31.59, p50:36.93, p75:43.17, p95:56.88,
    touch:{ "+5":84, "+10":71, "+15":59, "+20":49, "-5":70, "-10":51 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },

  // ---- 24-Aug-2026 single-name roll-forward: ORWE, struck on its own
  //      latest library close. Append-only.
  {
    instrument:"ORWE", asset_class:"equity",
    anchor_date:"2026-08-23", run_date:"2026-08-24", anchor_price:26.0, ccy:"EGP",
    horizon_label:"1 month", grade_date:"2026-09-23", grade_basis:"projected", horizon_days:22,
    cycle_no:3, reanchor_from:"2026-07-22", anchor_vol:0.351,
    signal_z:0.019, signal_alpha:0.0,
    note:"Cycle 3 roll-forward, 24-Aug-2026 — struck on the 23-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-23 and is graded in this same pass. The previous cone was anchored 2026-07-22; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) EG live fit nu=5.0, width_cal=0.951. PER-NAME WIDTH OVERLAY APPLIED (engine/adaptive_width.py): this name has cleared the 28-window history gate, so live_width_mult() returns 0.9000 on its OWN resolved 3-month residuals and the cone was simulated at an effective width_cal of 0.8559, not the pooled 0.951. It is an OVERLAY, NOT A REFIT: the pooled (nu, width_cal), the carry drift and the tail nu are untouched by it. rf_live 19.50% CBE main operation rate. Direction call UP but WEAK — this name’s own mom_combo z is +0.019, inside the 0.25 dead zone, so the tilt applied is exactly 0 and the cone is carry-centered. Horizons resolved by horizons.resolve() on EG’s own realized calendar — a calendar commitment, not a session count; the session counts (h=22 / 62) size the cone only.",
    p5:22.99, p25:25.11, p50:26.38, p75:27.73, p95:30.29,
    touch:{ "+5":51, "+10":23, "+15":10, "+20":4, "-5":36, "-10":12 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  {
    ...
    anchor_date:"2026-08-23", run_date:"2026-08-24", anchor_price:26.0, ccy:"EGP",
    horizon_label:"3 months", grade_date:"2026-11-23", grade_basis:"projected", horizon_days:62,
    cycle_no:3, reanchor_from:"2026-07-22", anchor_vol:0.3676,
    signal_z:0.019, signal_alpha:0.0,
    note:"Cycle 3 roll-forward, 24-Aug-2026 — struck on the 23-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-23 and is graded in this same pass. The previous cone was anchored 2026-07-22; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) EG live fit nu=5.0, width_cal=0.951. PER-NAME WIDTH OVERLAY APPLIED (engine/adaptive_width.py): this name has cleared the 28-window history gate, so live_width_mult() returns 0.9000 on its OWN resolved 3-month residuals and the cone was simulated at an effective width_cal of 0.8559, not the pooled 0.951. It is an OVERLAY, NOT A REFIT: the pooled (nu, width_cal), the carry drift and the tail nu are untouched by it. rf_live 19.50% CBE main operation rate. Direction call UP but WEAK — this name’s own mom_combo z is +0.019, inside the 0.25 dead zone, so the tilt applied is exactly 0 and the cone is carry-centered. Horizons resolved by horizons.resolve() on EG’s own realized calendar — a calendar commitment, not a session count; the session counts (h=22 / 62) size the cone only.",
    p5:21.35, p25:24.94, p50:27.21, p75:29.7, p95:34.65,
    touch:{ "+5":75, "+10":54, "+15":37, "+20":24, "-5":53, "-10":28 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  ...
  // ---- 24-Aug-2026 single-name roll-forward: RMDA, struck on its own
  //      latest library close. Append-only.
  {
    instrument:"RMDA", asset_class:"equity",
    anchor_date:"2026-08-23", run_date:"2026-08-24", anchor_price:6.35, ccy:"EGP",
    horizon_label:"1 month", grade_date:"2026-09-23", grade_basis:"projected", horizon_days:22,
    cycle_no:3, reanchor_from:"2026-07-22", anchor_vol:0.5203,
    signal_z:1.1855, signal_alpha:0.010745,
    note:"Cycle 3 roll-forward, 24-Aug-2026 — struck on the 23-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-23 and is graded in this same pass. The previous cone was anchored 2026-07-22; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) EG live fit nu=5.0, width_cal=0.951. rf_live 19.50% CBE main operation rate. Direction call UP, from this name’s own mom_combo z of +1.185 (outside the 0.25 dead zone); tilt +1.08% at 1M and +1.96% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on EG’s own realized calendar — a calendar commitment, not a session count; the session counts (h=22 / 62) size the cone only.",
    p5:5.19, p25:6.0, p50:6.51, p75:7.07, p95:8.17,
    touch:{ "+5":67, "+10":44, "+15":28, "+20":17, "-5":52, "-10":27 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  {
    ...
    anchor_date:"2026-08-23", run_date:"2026-08-24", anchor_price:6.35, ccy:"EGP",
    horizon_label:"3 months", grade_date:"2026-11-23", grade_basis:"projected", horizon_days:62,
    cycle_no:3, reanchor_from:"2026-07-22", anchor_vol:0.511,
    signal_z:1.1855, signal_alpha:0.01943,
    note:"Cycle 3 roll-forward, 24-Aug-2026 — struck on the 23-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-23 and is graded in this same pass. The previous cone was anchored 2026-07-22; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) EG live fit nu=5.0, width_cal=0.951. rf_live 19.50% CBE main operation rate. Direction call UP, from this name’s own mom_combo z of +1.185 (outside the 0.25 dead zone); tilt +1.08% at 1M and +1.96% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on EG’s own realized calendar — a calendar commitment, not a session count; the session counts (h=22 / 62) size the cone only.",
    p5:4.66, p25:5.92, p50:6.78, p75:7.76, p95:9.85,
    touch:{ "+5":83, "+10":69, "+15":55, "+20":44, "-5":65, "-10":44 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },

  // ---- 24-Aug-2026 single-name roll-forward: TMGH, struck on its own
  //      latest library close. Append-only.
  {
    instrument:"TMGH", asset_class:"equity",
    anchor_date:"2026-08-23", run_date:"2026-08-24", anchor_price:97.8, ccy:"EGP",
    horizon_label:"1 month", grade_date:"2026-09-23", grade_basis:"projected", horizon_days:22,
    cycle_no:4, reanchor_from:"2026-07-22", anchor_vol:0.3209,
    signal_z:1.263, signal_alpha:0.007173,
    ...
    p5:86.73, p25:95.0, p50:99.95, p75:105.22, p95:115.25,
    touch:{ "+5":55, "+10":26, "+15":12, "+20":5, "-5":34, "-10":12 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  {
    ...
    anchor_date:"2026-08-23", run_date:"2026-08-24", anchor_price:97.8, ccy:"EGP",
    horizon_label:"3 months", grade_date:"2026-11-23", grade_basis:"projected", horizon_days:62,
    cycle_no:4, reanchor_from:"2026-07-22", anchor_vol:0.3411,
    signal_z:1.263, signal_alpha:0.014039,
    note:"Cycle 4 roll-forward, 24-Aug-2026 — struck on the 23-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-23 and is graded in this same pass. The previous cone was anchored 2026-07-22; every still-open cohort on cycle 3 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) EG live fit nu=5.0, width_cal=0.951. PER-NAME WIDTH OVERLAY APPLIED (engine/adaptive_width.py): this name has cleared the 28-window history gate, so live_width_mult() returns 1.0160 on its OWN resolved 3-month residuals and the cone was simulated at an effective width_cal of 0.9662, not the pooled 0.951. It is an OVERLAY, NOT A REFIT: the pooled (nu, width_cal), the carry drift and the tail nu are untouched by it. rf_live 19.50% CBE main operation rate. Direction call UP, from this name’s own mom_combo z of +1.263 (outside the 0.25 dead zone); tilt +0.72% at 1M and +1.41% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on EG’s own realized calendar — a calendar commitment, not a session count; the session counts (h=22 / 62) size the cone only.",
  ...
  // ---- 24-Aug-2026 single-name roll-forward: ORAS, struck on its own
  //      latest library close. Append-only.
  {
    instrument:"ORAS", asset_class:"equity",
    anchor_date:"2026-08-23", run_date:"2026-08-24", anchor_price:782.25, ccy:"EGP",
    horizon_label:"1 month", grade_date:"2026-09-23", grade_basis:"projected", horizon_days:22,
    cycle_no:3, reanchor_from:"2026-07-22", anchor_vol:0.3968,
    signal_z:1.9204, signal_alpha:0.013899,
    note:"Cycle 3 roll-forward, 24-Aug-2026 — struck on the 23-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-23 and is graded in this same pass. The previous cone was anchored 2026-07-22; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) EG live fit nu=5.0, width_cal=0.951. PER-NAME WIDTH OVERLAY APPLIED (engine/adaptive_width.py): this name has cleared the 28-window history gate, so live_width_mult() returns 1.0471 on its OWN resolved 3-month residuals and the cone was simulated at an effective width_cal of 0.9958, not the pooled 0.951. It is an OVERLAY, NOT A REFIT: the pooled (nu, width_cal), the carry drift and the tail nu are untouched by it. rf_live 19.50% CBE main operation rate. Direction call UP, from this name’s own mom_combo z of +1.920 (outside the 0.25 dead zone); tilt +1.40% at 1M and +2.64% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on EG’s own realized calendar — a calendar commitment, not a session count; the session counts (h=22 / 62) size the cone only.",
    p5:671.62, p25:754.33, p50:804.74, p75:859.28, p95:965.02,
  ...
  },
  {
    ...
    anchor_date:"2026-08-23", run_date:"2026-08-24", anchor_price:782.25, ccy:"EGP",
    horizon_label:"3 months", grade_date:"2026-11-23", grade_basis:"projected", horizon_days:62,
    cycle_no:3, reanchor_from:"2026-07-22", anchor_vol:0.4047,
    signal_z:1.9204, signal_alpha:0.026103,
    note:"Cycle 3 roll-forward, 24-Aug-2026 — struck on the 23-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-23 and is graded in this same pass. The previous cone was anchored 2026-07-22; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) EG live fit nu=5.0, width_cal=0.951. PER-NAME WIDTH OVERLAY APPLIED (engine/adaptive_width.py): this name has cleared the 28-window history gate, so live_width_mult() returns 1.0471 on its OWN resolved 3-month residuals and the cone was simulated at an effective width_cal of 0.9958, not the pooled 0.951. It is an OVERLAY, NOT A REFIT: the pooled (nu, width_cal), the carry drift and the tail nu are untouched by it. rf_live 19.50% CBE main operation rate. Direction call UP, from this name’s own mom_combo z of +1.920 (outside the 0.25 dead zone); tilt +1.40% at 1M and +2.64% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on EG’s own realized calendar — a calendar commitment, not a session count; the session counts (h=22 / 62) size the cone only.",
    p5:615.97, p25:751.65, p50:840.65, p75:940.16, p95:1145.51,
  ...
  // ---- 24-Aug-2026 single-name roll-forward: OIH, struck on its own
  //      latest library close. Append-only.
  {
    instrument:"OIH", asset_class:"equity",
    anchor_date:"2026-08-23", run_date:"2026-08-24", anchor_price:1.88, ccy:"EGP",
    horizon_label:"1 month", grade_date:"2026-09-23", grade_basis:"projected", horizon_days:22,
    cycle_no:3, reanchor_from:"2026-07-22", anchor_vol:0.4561,
    signal_z:0.7063, signal_alpha:0.005612,
    note:"Cycle 3 roll-forward, 24-Aug-2026 — struck on the 23-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-23 and is graded in this same pass. The previous cone was anchored 2026-07-22; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) EG live fit nu=5.0, width_cal=0.951. rf_live 19.50% CBE main operation rate. Direction call UP, from this name’s own mom_combo z of +0.706 (outside the 0.25 dead zone); tilt +0.56% at 1M and +1.11% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on EG’s own realized calendar — a calendar commitment, not a session count; the session counts (h=22 / 62) size the cone only.",
    p5:1.57, p25:1.79, p50:1.92, p75:2.06, p95:2.34,
    touch:{ "+5":63, "+10":38, "+15":22, "+20":12, "-5":48, "-10":24 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  {
    ...
    anchor_date:"2026-08-23", run_date:"2026-08-24", anchor_price:1.88, ccy:"EGP",
    horizon_label:"3 months", grade_date:"2026-11-23", grade_basis:"projected", horizon_days:62,
    cycle_no:3, reanchor_from:"2026-07-22", anchor_vol:0.4859,
    signal_z:0.7063, signal_alpha:0.011008,
    note:"Cycle 3 roll-forward, 24-Aug-2026 — struck on the 23-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-23 and is graded in this same pass. The previous cone was anchored 2026-07-22; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) EG live fit nu=5.0, width_cal=0.951. rf_live 19.50% CBE main operation rate. Direction call UP, from this name’s own mom_combo z of +0.706 (outside the 0.25 dead zone); tilt +0.56% at 1M and +1.11% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on EG’s own realized calendar — a calendar commitment, not a session count; the session counts (h=22 / 62) size the cone only.",
    p5:1.39, p25:1.75, p50:1.99, p75:2.26, p95:2.84,
    touch:{ "+5":81, "+10":66, "+15":52, "+20":41, "-5":65, "-10":43 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },

  // ---- 24-Aug-2026 single-name roll-forward: RAYA, struck on its own
  //      latest library close. Append-only.
  {
    instrument:"RAYA", asset_class:"equity",
    anchor_date:"2026-08-23", run_date:"2026-08-24", anchor_price:7.07, ccy:"EGP",
    horizon_label:"1 month", grade_date:"2026-09-23", grade_basis:"projected", horizon_days:22,
    cycle_no:3, reanchor_from:"2026-07-22", anchor_vol:0.3754,
    signal_z:1.8859, signal_alpha:0.012332,
    ...
    p5:6.17, p25:6.85, p50:7.26, p75:7.71, p95:8.56,
    touch:{ "+5":61, "+10":33, "+15":17, "+20":9, "-5":38, "-10":15 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  {
    ...
    anchor_date:"2026-08-23", run_date:"2026-08-24", anchor_price:7.07, ccy:"EGP",
    horizon_label:"3 months", grade_date:"2026-11-23", grade_basis:"projected", horizon_days:62,
    cycle_no:3, reanchor_from:"2026-07-22", anchor_vol:0.397,
    signal_z:1.8859, signal_alpha:0.024017,
    note:"Cycle 3 roll-forward, 24-Aug-2026 — struck on the 23-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-23 and is graded in this same pass. The previous cone was anchored 2026-07-22; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) EG live fit nu=5.0, width_cal=0.951. rf_live 19.50% CBE main operation rate. Direction call UP, from this name’s own mom_combo z of +1.886 (outside the 0.25 dead zone); tilt +1.24% at 1M and +2.43% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on EG’s own realized calendar — a calendar commitment, not a session count; the session counts (h=22 / 62) size the cone only.",
  ...
  {
    instrument:"DIB", asset_class:"equity",
    anchor_date:"2026-08-21", run_date:"2026-08-24", anchor_price:7.4, ccy:"AED",
    horizon_label:"1 month", grade_date:"2026-09-21", grade_basis:"projected", horizon_days:21,
    cycle_no:3, reanchor_from:"2026-07-24", anchor_vol:0.2077,
    signal_z:-1.0791, signal_alpha:-0.00645,
    note:"Cycle 3 roll-forward, 24-Aug-2026 — struck on the 21-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-24, but this name’s library ends 2026-08-21, so that cohort is not gradable yet: it stays OPEN and is graded on its own date once its close lands. The previous cone was anchored 2026-07-24; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) AE live fit nu=10.0, width_cal=0.923. rf_live 3.65% CBUAE base rate (AED peg -> Fed path). Direction call DOWN, from this name’s own mom_combo z of -1.079 (outside the 0.25 dead zone); tilt -0.64% at 1M and -2.04% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on AE’s own realized calendar — a calendar commitment, not a session count; the session counts (h=21 / 64) size the cone only.",
    p5:6.75, p25:7.12, p50:7.37, p75:7.63, p95:8.07,
    touch:{ "+5":27, "+10":6, "+15":1, "+20":0, "-5":29, "-10":5 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  {
    ...
    anchor_date:"2026-08-21", run_date:"2026-08-24", anchor_price:7.4, ccy:"AED",
    horizon_label:"3 months", grade_date:"2026-11-23", grade_basis:"projected", horizon_days:64,
    cycle_no:3, reanchor_from:"2026-07-24", anchor_vol:0.2214,
    signal_z:-1.0791, signal_alpha:-0.020561,
    note:"Cycle 3 roll-forward, 24-Aug-2026 — struck on the 21-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-24, but this name’s library ends 2026-08-21, so that cohort is not gradable yet: it stays OPEN and is graded on its own date once its close lands. The previous cone was anchored 2026-07-24; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) AE live fit nu=10.0, width_cal=0.923. rf_live 3.65% CBUAE base rate (AED peg -> Fed path). Direction call DOWN, from this name’s own mom_combo z of -1.079 (outside the 0.25 dead zone); tilt -0.64% at 1M and -2.04% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on AE’s own realized calendar — a calendar commitment, not a session count; the session counts (h=21 / 64) size the cone only.",
    p5:6.19, p25:6.86, p50:7.32, p75:7.8, p95:8.65,
    touch:{ "+5":52, "+10":26, "+15":12, "+20":6, "-5":58, "-10":28 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },

  // ---- 24-Aug-2026 single-name roll-forward: PRDC, struck on its own
  //      latest library close. Append-only.
  {
    instrument:"PRDC", asset_class:"equity",
    anchor_date:"2026-08-23", run_date:"2026-08-24", anchor_price:9.69, ccy:"EGP",
    horizon_label:"1 month", grade_date:"2026-09-23", grade_basis:"projected", horizon_days:22,
    cycle_no:3, reanchor_from:"2026-07-22", anchor_vol:0.4928,
    signal_z:2.4119, signal_alpha:0.020705,
    note:"Cycle 3 roll-forward, 24-Aug-2026 — struck on the 23-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-23 and is graded in this same pass. The previous cone was anchored 2026-07-22; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) EG live fit nu=5.0, width_cal=0.951. rf_live 19.50% CBE main operation rate. Direction call UP, from this name’s own mom_combo z of +2.412 (outside the 0.25 dead zone); tilt +2.09% at 1M and +3.82% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on EG’s own realized calendar — a calendar commitment, not a session count; the session counts (h=22 / 62) size the cone only.",
    p5:8.1, p25:9.29, p50:10.04, p75:10.85, p95:12.45,
    touch:{ "+5":69, "+10":45, "+15":28, "+20":17, "-5":47, "-10":24 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  {
    ...
    anchor_date:"2026-08-23", run_date:"2026-08-24", anchor_price:9.69, ccy:"EGP",
    horizon_label:"3 months", grade_date:"2026-11-23", grade_basis:"projected", horizon_days:62,
    cycle_no:3, reanchor_from:"2026-07-22", anchor_vol:0.4845,
    signal_z:2.4119, signal_alpha:0.037482,
    note:"Cycle 3 roll-forward, 24-Aug-2026 — struck on the 23-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-23 and is graded in this same pass. The previous cone was anchored 2026-07-22; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) EG live fit nu=5.0, width_cal=0.951. rf_live 19.50% CBE main operation rate. Direction call UP, from this name’s own mom_combo z of +2.412 (outside the 0.25 dead zone); tilt +2.09% at 1M and +3.82% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on EG’s own realized calendar — a calendar commitment, not a session count; the session counts (h=22 / 62) size the cone only.",
    p5:7.38, p25:9.27, p50:10.53, p75:11.97, p95:15.01,
    touch:{ "+5":84, "+10":71, "+15":57, "+20":45, "-5":61, "-10":39 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },

  // ---- 24-Aug-2026 single-name roll-forward: ALDAR, struck on its own
  //      latest library close. Append-only.
  {
    instrument:"ALDAR", asset_class:"equity",
    anchor_date:"2026-08-21", run_date:"2026-08-24", anchor_price:7.7, ccy:"AED",
    horizon_label:"1 month", grade_date:"2026-09-21", grade_basis:"projected", horizon_days:21,
    cycle_no:3, reanchor_from:"2026-07-24", anchor_vol:0.2708,
    signal_z:-1.2475, signal_alpha:-0.009646,
    note:"Cycle 3 roll-forward, 24-Aug-2026 — struck on the 21-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-24, but this name’s library ends 2026-08-21, so that cohort is not gradable yet: it stays OPEN and is graded on its own date once its close lands. The previous cone was anchored 2026-07-24; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) AE live fit nu=10.0, width_cal=0.916. rf_live 3.65% CBUAE base rate (AED peg -> Fed path). Direction call DOWN, from this name’s own mom_combo z of -1.247 (outside the 0.25 dead zone); tilt -0.96% at 1M and -3.03% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on AE’s own realized calendar — a calendar commitment, not a session count; the session counts (h=21 / 64) size the cone only.",
    p5:6.82, p25:7.31, p50:7.65, p75:8.0, p95:8.59,
    touch:{ "+5":36, "+10":12, "+15":4, "+20":1, "-5":41, "-10":12 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  {
    ...
    anchor_date:"2026-08-21", run_date:"2026-08-24", anchor_price:7.7, ccy:"AED",
    horizon_label:"3 months", grade_date:"2026-11-23", grade_basis:"projected", horizon_days:64,
    cycle_no:3, reanchor_from:"2026-07-24", anchor_vol:0.2887,
    signal_z:-1.2475, signal_alpha:-0.030753,
    note:"Cycle 3 roll-forward, 24-Aug-2026 — struck on the 21-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-24, but this name’s library ends 2026-08-21, so that cohort is not gradable yet: it stays OPEN and is graded on its own date once its close lands. The previous cone was anchored 2026-07-24; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) AE live fit nu=10.0, width_cal=0.916. rf_live 3.65% CBUAE base rate (AED peg -> Fed path). Direction call DOWN, from this name’s own mom_combo z of -1.247 (outside the 0.25 dead zone); tilt -0.96% at 1M and -3.03% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on AE’s own realized calendar — a calendar commitment, not a session count; the session counts (h=21 / 64) size the cone only.",
    p5:6.07, p25:6.94, p50:7.54, p75:8.19, p95:9.35,
    touch:{ "+5":59, "+10":35, "+15":20, "+20":11, "-5":68, "-10":41 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  ...
  // ---- 30-Aug-2026 single-name roll-forward: EMAARDEV, struck on its own
  //      latest library close. Append-only.
  {
    instrument:"EMAARDEV", asset_class:"equity",
    anchor_date:"2026-08-27", run_date:"2026-08-30", anchor_price:12.76, ccy:"AED",
    horizon_label:"1 month", grade_date:"2026-09-28", grade_basis:"projected", horizon_days:22,
    cycle_no:3, reanchor_from:"2026-07-24", anchor_vol:0.3143,
    signal_z:-0.9582, signal_alpha:-0.009273,
    note:"Cycle 3 roll-forward, 30-Aug-2026 — struck on the 27-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-24 and is graded in this same pass. The previous cone was anchored 2026-07-24; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) AE live fit nu=4.5, width_cal=0.965. rf_live 3.65% CBUAE base rate (AED peg -> Fed path). Direction call DOWN, from this name’s own mom_combo z of -0.958 (outside the 0.25 dead zone); tilt -0.92% at 1M and -2.87% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on AE’s own realized calendar — a calendar commitment, not a session count; the session counts (h=22 / 64) size the cone only.",
    p5:11.08, p25:12.08, p50:12.68, p75:13.32, p95:14.55,
    touch:{ "+5":40, "+10":16, "+15":7, "+20":3, "-5":44, "-10":16 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  {
    ...
    anchor_date:"2026-08-27", run_date:"2026-08-30", anchor_price:12.76, ccy:"AED",
    horizon_label:"3 months", grade_date:"2026-11-27", grade_basis:"projected", horizon_days:64,
    cycle_no:3, reanchor_from:"2026-07-24", anchor_vol:0.3373,
    signal_z:-0.9582, signal_alpha:-0.029075,
    note:"Cycle 3 roll-forward, 30-Aug-2026 — struck on the 27-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-24 and is graded in this same pass. The previous cone was anchored 2026-07-24; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) AE live fit nu=4.5, width_cal=0.965. rf_live 3.65% CBUAE base rate (AED peg -> Fed path). Direction call DOWN, from this name’s own mom_combo z of -0.958 (outside the 0.25 dead zone); tilt -0.92% at 1M and -2.87% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on AE’s own realized calendar — a calendar commitment, not a session count; the session counts (h=22 / 64) size the cone only.",
    p5:9.73, p25:11.44, p50:12.52, p75:13.69, p95:16.15,
    touch:{ "+5":61, "+10":39, "+15":24, "+20":16, "-5":69, "-10":44 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },

  // ---- 30-Aug-2026 single-name roll-forward: FAB, struck on its own
  //      latest library close. Append-only.
  {
    instrument:"FAB", asset_class:"equity",
    anchor_date:"2026-08-27", run_date:"2026-08-30", anchor_price:19.64, ccy:"AED",
    horizon_label:"1 month", grade_date:"2026-09-28", grade_basis:"projected", horizon_days:22,
    cycle_no:3, reanchor_from:"2026-07-24", anchor_vol:0.2535,
    signal_z:0.0356, signal_alpha:0.0,
    note:"Cycle 3 roll-forward, 30-Aug-2026 — struck on the 27-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-24 and is graded in this same pass. The previous cone was anchored 2026-07-24; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) AE live fit nu=4.5, width_cal=0.965. rf_live 3.65% CBUAE base rate (AED peg -> Fed path). Direction call UP but WEAK — this name’s own mom_combo z is +0.036, inside the 0.25 dead zone, so the tilt applied is exactly 0 and the cone is carry-centered. Horizons resolved by horizons.resolve() on AE’s own realized calendar — a calendar commitment, not a session count; the session counts (h=22 / 64) size the cone only.",
    p5:17.67, p25:18.95, p50:19.69, p75:20.49, p95:22.01,
    touch:{ "+5":37, "+10":12, "+15":5, "+20":2, "-5":31, "-10":8 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  {
    ...
    anchor_date:"2026-08-27", run_date:"2026-08-30", anchor_price:19.64, ccy:"AED",
    horizon_label:"3 months", grade_date:"2026-11-27", grade_basis:"projected", horizon_days:64,
    cycle_no:3, reanchor_from:"2026-07-24", anchor_vol:0.2631,
    signal_z:0.0356, signal_alpha:0.0,
    note:"Cycle 3 roll-forward, 30-Aug-2026 — struck on the 27-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-24 and is graded in this same pass. The previous cone was anchored 2026-07-24; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) AE live fit nu=4.5, width_cal=0.965. rf_live 3.65% CBUAE base rate (AED peg -> Fed path). Direction call UP but WEAK — this name’s own mom_combo z is +0.036, inside the 0.25 dead zone, so the tilt applied is exactly 0 and the cone is carry-centered. Horizons resolved by horizons.resolve() on AE’s own realized calendar — a calendar commitment, not a session count; the session counts (h=22 / 64) size the cone only.",
    p5:16.29, p25:18.49, p50:19.83, p75:21.26, p95:24.2,
    touch:{ "+5":61, "+10":36, "+15":20, "+20":12, "-5":54, "-10":27 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },

  // ---- 30-Aug-2026 single-name roll-forward: ENBD, struck on its own
  //      latest library close. Append-only.
  {
    instrument:"ENBD", asset_class:"equity",
    anchor_date:"2026-08-27", run_date:"2026-08-30", anchor_price:31.0, ccy:"AED",
    horizon_label:"1 month", grade_date:"2026-09-28", grade_basis:"projected", horizon_days:22,
    cycle_no:3, reanchor_from:"2026-07-24", anchor_vol:0.3183,
    signal_z:-0.2092, signal_alpha:0.0,
    note:"Cycle 3 roll-forward, 30-Aug-2026 — struck on the 27-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-24 and is graded in this same pass. The previous cone was anchored 2026-07-24; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) AE live fit nu=4.5, width_cal=0.965. rf_live 3.65% CBUAE base rate (AED peg -> Fed path). Direction call DOWN but WEAK — this name’s own mom_combo z is -0.209, inside the 0.25 dead zone, so the tilt applied is exactly 0 and the cone is carry-centered. Horizons resolved by horizons.resolve() on AE’s own realized calendar — a calendar commitment, not a session count; the session counts (h=22 / 64) size the cone only.",
    p5:27.12, p25:29.61, p50:31.08, p75:32.67, p95:35.74,
    touch:{ "+5":45, "+10":19, "+15":8, "+20":4, "-5":40, "-10":14 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  {
    ...
    anchor_date:"2026-08-27", run_date:"2026-08-30", anchor_price:31.0, ccy:"AED",
    horizon_label:"3 months", grade_date:"2026-11-27", grade_basis:"projected", horizon_days:64,
    cycle_no:3, reanchor_from:"2026-07-24", anchor_vol:0.3236,
    signal_z:-0.2092, signal_alpha:0.0,
    note:"Cycle 3 roll-forward, 30-Aug-2026 — struck on the 27-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-24 and is graded in this same pass. The previous cone was anchored 2026-07-24; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) AE live fit nu=4.5, width_cal=0.965. rf_live 3.65% CBUAE base rate (AED peg -> Fed path). Direction call DOWN but WEAK — this name’s own mom_combo z is -0.209, inside the 0.25 dead zone, so the tilt applied is exactly 0 and the cone is carry-centered. Horizons resolved by horizons.resolve() on AE’s own realized calendar — a calendar commitment, not a session count; the session counts (h=22 / 64) size the cone only.",
    p5:24.57, p25:28.73, p50:31.31, p75:34.11, p95:39.99,
    touch:{ "+5":67, "+10":44, "+15":28, "+20":18, "-5":61, "-10":35 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  ...
  {
    instrument:"ACWA", asset_class:"equity",
    anchor_date:"2026-08-31", run_date:"2026-09-01", anchor_price:191.9, ccy:"SAR",
    horizon_label:"1 month", grade_date:"2026-09-30", grade_basis:"projected", horizon_days:21,
    cycle_no:3, reanchor_from:"2026-07-26", anchor_vol:0.3351,
    signal_z:-0.3418, signal_alpha:-0.003269,
    ...
    p5:162.61, p25:179.85, p50:191.89, p75:204.9, p95:226.7,
    touch:{ "+5":53, "+10":27, "+15":13, "+20":6, "-5":52, "-10":23 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  {
    ...
    anchor_date:"2026-08-31", run_date:"2026-09-01", anchor_price:191.9, ccy:"SAR",
    horizon_label:"3 months", grade_date:"2026-11-30", grade_basis:"projected", horizon_days:63,
    cycle_no:3, reanchor_from:"2026-07-26", anchor_vol:0.3549,
    signal_z:-0.3418, signal_alpha:-0.005996,
    note:"Cycle 3 roll-forward, 01-Sep-2026 — struck on the 31-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-26 and is graded in this same pass. The previous cone was anchored 2026-07-26; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) SA live fit nu=12.0, width_cal=1.063. rf_live 4.25% SAMA repo-anchored estimate. Direction call DOWN, from this name’s own mom_12_1 z of -0.342 (outside the 0.25 dead zone); tilt -0.33% at 1M and -0.60% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on SA’s own realized calendar — a calendar commitment, not a session count; the session counts (h=21 / 63) size the cone only.",
  ...
  // ---- 01-Sep-2026 single-name roll-forward: EXTRA, struck on its own
  //      latest library close. Append-only.
  {
    instrument:"EXTRA", asset_class:"equity",
    anchor_date:"2026-08-31", run_date:"2026-09-01", anchor_price:65.25, ccy:"SAR",
    horizon_label:"1 month", grade_date:"2026-09-30", grade_basis:"projected", horizon_days:21,
    cycle_no:3, reanchor_from:"2026-07-26", anchor_vol:0.2268,
    signal_z:-1.7785, signal_alpha:-0.011511,
    note:"Cycle 3 roll-forward, 01-Sep-2026 — struck on the 31-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-26 and is graded in this same pass. The previous cone was anchored 2026-07-26; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) SA live fit nu=12.0, width_cal=1.063. NAME-LEVEL CALIBRATION: FAIL, robustly — skill -0.0371 over 44 scored windows, negative under every bootstrap block size {2,3,4} (block-2 CI [-0.063,-0.022]). The cone is TOO NARROW: only 86% coverage against a 90% target and 52% against 50%, PIT mean 0.506. Read the bands as an OUTER bound. rf_live 4.25% SAMA repo-anchored estimate. Direction call DOWN, from this name’s own mom_12_1 z of -1.779 (outside the 0.25 dead zone); tilt -1.14% at 1M and -2.24% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on SA’s own realized calendar — a calendar commitment, not a session count; the session counts (h=21 / 63) size the cone only.",
    p5:57.85, p25:61.94, p50:64.71, p75:67.65, p95:72.44,
    touch:{ "+5":35, "+10":11, "+15":3, "+20":1, "-5":41, "-10":11 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  {
    ...
    anchor_date:"2026-08-31", run_date:"2026-09-01", anchor_price:65.25, ccy:"SAR",
    horizon_label:"3 months", grade_date:"2026-11-30", grade_basis:"projected", horizon_days:63,
    cycle_no:3, reanchor_from:"2026-07-26", anchor_vol:0.2577,
    signal_z:-1.7785, signal_alpha:-0.022657,
    note:"Cycle 3 roll-forward, 01-Sep-2026 — struck on the 31-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-26 and is graded in this same pass. The previous cone was anchored 2026-07-26; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) SA live fit nu=12.0, width_cal=1.063. NAME-LEVEL CALIBRATION: FAIL, robustly — skill -0.0371 over 44 scored windows, negative under every bootstrap block size {2,3,4} (block-2 CI [-0.063,-0.022]). The cone is TOO NARROW: only 86% coverage against a 90% target and 52% against 50%, PIT mean 0.506. Read the bands as an OUTER bound. rf_live 4.25% SAMA repo-anchored estimate. Direction call DOWN, from this name’s own mom_12_1 z of -1.779 (outside the 0.25 dead zone); tilt -1.14% at 1M and -2.24% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on SA’s own realized calendar — a calendar commitment, not a session count; the session counts (h=21 / 63) size the cone only.",
    p5:51.68, p25:59.17, p50:64.47, p75:70.24, p95:80.6,
    touch:{ "+5":62, "+10":39, "+15":23, "+20":13, "-5":67, "-10":41 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },

  // ---- 01-Sep-2026 single-name roll-forward: RIBL, struck on its own
  //      latest library close. Append-only.
  {
    instrument:"RIBL", asset_class:"equity",
    anchor_date:"2026-08-31", run_date:"2026-09-01", anchor_price:20.9, ccy:"SAR",
    horizon_label:"1 month", grade_date:"2026-09-30", grade_basis:"projected", horizon_days:21,
    cycle_no:3, reanchor_from:"2026-07-26", anchor_vol:0.1819,
    signal_z:0.0054, signal_alpha:0.0,
    note:"Cycle 3 roll-forward, 01-Sep-2026 — struck on the 31-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-26 and is graded in this same pass. The previous cone was anchored 2026-07-26; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) SA live fit nu=12.0, width_cal=1.063. rf_live 4.25% SAMA repo-anchored estimate. Direction call UP but WEAK — this name’s own mom_12_1 z is +0.005, inside the 0.25 dead zone, so the tilt applied is exactly 0 and the cone is carry-centered. Horizons resolved by horizons.resolve() on SA’s own realized calendar — a calendar commitment, not a session count; the session counts (h=21 / 63) size the cone only.",
    p5:19.17, p25:20.24, p50:20.97, p75:21.73, p95:22.95,
    touch:{ "+5":32, "+10":7, "+15":1, "+20":0, "-5":26, "-10":4 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  {
    ...
    anchor_date:"2026-08-31", run_date:"2026-09-01", anchor_price:20.9, ccy:"SAR",
    horizon_label:"3 months", grade_date:"2026-11-30", grade_basis:"projected", horizon_days:63,
    cycle_no:3, reanchor_from:"2026-07-26", anchor_vol:0.1926,
    signal_z:0.0054, signal_alpha:0.0,
    note:"Cycle 3 roll-forward, 01-Sep-2026 — struck on the 31-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-26 and is graded in this same pass. The previous cone was anchored 2026-07-26; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) SA live fit nu=12.0, width_cal=1.063. rf_live 4.25% SAMA repo-anchored estimate. Direction call UP but WEAK — this name’s own mom_12_1 z is +0.005, inside the 0.25 dead zone, so the tilt applied is exactly 0 and the cone is carry-centered. Horizons resolved by horizons.resolve() on SA’s own realized calendar — a calendar commitment, not a session count; the session counts (h=21 / 63) size the cone only.",
    p5:17.9, p25:19.81, p50:21.12, p75:22.51, p95:24.95,
    touch:{ "+5":60, "+10":33, "+15":16, "+20":8, "-5":51, "-10":22 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  ...
  //      latest library close. Append-only.
  {
    ...
    signal_z:0.369, signal_alpha:0.003355,
    note:"Cycle 3 roll-forward, 01-Sep-2026 — struck on the 31-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-26 and is graded in this same pass. The previous cone was anchored 2026-07-26; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) SA live fit nu=12.0, width_cal=1.056. rf_live 4.25% SAMA repo-anchored estimate. Direction call UP, from this name’s own mom_12_1 z of +0.369 (outside the 0.25 dead zone); tilt +0.34% at 1M and +0.59% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on SA’s own realized calendar — a calendar commitment, not a session count; the session counts (h=21 / 63) size the cone only.",
    p5:56.85, p25:62.56, p50:66.54, p75:70.82, p95:77.96,
    touch:{ "+5":53, "+10":27, "+15":13, "+20":5, "-5":47, "-10":20 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  {
    ...
    signal_z:0.369, signal_alpha:0.005837,
    note:"Cycle 3 roll-forward, 01-Sep-2026 — struck on the 31-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-26 and is graded in this same pass. The previous cone was anchored 2026-07-26; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) SA live fit nu=12.0, width_cal=1.056. rf_live 4.25% SAMA repo-anchored estimate. Direction call UP, from this name’s own mom_12_1 z of +0.369 (outside the 0.25 dead zone); tilt +0.34% at 1M and +0.59% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on SA’s own realized calendar — a calendar commitment, not a session count; the session counts (h=21 / 63) size the cone only.",
    p5:51.07, p25:60.41, p50:67.22, p75:74.75, p95:88.68,
    touch:{ "+5":73, "+10":54, "+15":38, "+20":26, "-5":66, "-10":43 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },

  // ---- 2026-09-01 single-name roll-forward: ARAMCO, struck on its own
  //      latest library close. Append-only.
  {
    instrument:"ARAMCO", asset_class:"equity",
    anchor_date:"2026-08-31", run_date:"2026-09-01", anchor_price:26.06, ccy:"SAR",
    horizon_label:"1 month", grade_date:"2026-09-30", grade_basis:"projected", horizon_days:21,
    cycle_no:3, reanchor_from:"2026-07-26", anchor_vol:0.132,
    signal_z:0.749, signal_alpha:0.002803,
    note:"Cycle 3 roll-forward, 2026-09-01 — struck on the 31-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-26 and is graded in this same pass. The previous cone was anchored 2026-07-26; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) SA live fit nu=15.0, width_cal=1.056. rf_live 4.25% SAMA repo-anchored estimate. Direction call UP, from this name’s own mom_12_1 z of +0.749 (outside the 0.25 dead zone); tilt +0.28% at 1M and +0.52% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on SA’s own realized calendar — a calendar commitment, not a session count; the session counts (h=21 / 63) size the cone only.",
    p5:24.56, p25:25.55, p50:26.22, p75:26.91, p95:28.0,
    touch:{ "+5":21, "+10":2, "+15":0, "+20":0, "-5":12, "-10":1 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  {
    ...
    anchor_date:"2026-08-31", run_date:"2026-09-01", anchor_price:26.06, ccy:"SAR",
    horizon_label:"3 months", grade_date:"2026-11-30", grade_basis:"projected", horizon_days:63,
    cycle_no:3, reanchor_from:"2026-07-26", anchor_vol:0.1416,
    signal_z:0.749, signal_alpha:0.005207,
    note:"Cycle 3 roll-forward, 2026-09-01 — struck on the 31-Aug-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-26 and is graded in this same pass. The previous cone was anchored 2026-07-26; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) SA live fit nu=15.0, width_cal=1.056. rf_live 4.25% SAMA repo-anchored estimate. Direction call UP, from this name’s own mom_12_1 z of +0.749 (outside the 0.25 dead zone); tilt +0.28% at 1M and +0.52% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on SA’s own realized calendar — a calendar commitment, not a session count; the session counts (h=21 / 63) size the cone only.",
    p5:23.44, p25:25.24, p50:26.47, p75:27.75, p95:29.89,
    touch:{ "+5":53, "+10":22, "+15":8, "+20":2, "-5":36, "-10":10 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },

  // ---- 01-Sep-2026 single-name roll-forward: SABIC, struck on its own
  //      latest library close. Append-only.
  {
    instrument:"SABIC", asset_class:"equity",
    anchor_date:"2026-09-01", run_date:"2026-09-01", anchor_price:50.1, ccy:"SAR",
    horizon_label:"1 month", grade_date:"2026-10-01", grade_basis:"projected", horizon_days:21,
    cycle_no:3, reanchor_from:"2026-07-26", anchor_vol:0.177,
    signal_z:-0.8661, signal_alpha:-0.004347,
    note:"Cycle 3 roll-forward, 01-Sep-2026 — struck on the 01-Sep-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-26 and is graded in this same pass. The previous cone was anchored 2026-07-26; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) SA live fit nu=15.0, width_cal=1.056. rf_live 4.25% SAMA repo-anchored estimate. Direction call DOWN, from this name’s own mom_12_1 z of -0.866 (outside the 0.25 dead zone); tilt -0.43% at 1M and -0.82% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on SA’s own realized calendar — a calendar commitment, not a session count; the session counts (h=21 / 63) size the cone only.",
    p5:45.85, p25:48.35, p50:50.04, p75:51.82, p95:54.66,
    touch:{ "+5":28, "+10":6, "+15":1, "+20":0, "-5":27, "-10":4 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  {
    ...
    cycle_no:3, reanchor_from:"2026-07-26", anchor_vol:0.1945,
    signal_z:-0.8661, signal_alpha:-0.008274,
    note:"Cycle 3 roll-forward, 01-Sep-2026 — struck on the 01-Sep-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-26 and is graded in this same pass. The previous cone was anchored 2026-07-26; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) SA live fit nu=15.0, width_cal=1.056. rf_live 4.25% SAMA repo-anchored estimate. Direction call DOWN, from this name’s own mom_12_1 z of -0.866 (outside the 0.25 dead zone); tilt -0.43% at 1M and -0.82% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on SA’s own realized calendar — a calendar commitment, not a session count; the session counts (h=21 / 63) size the cone only.",
    p5:42.5, p25:47.04, p50:50.21, p75:53.58, p95:59.34,
    touch:{ "+5":58, "+10":30, "+15":15, "+20":7, "-5":54, "-10":25 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  ...
  // ---- 01-Sep-2026 single-name roll-forward: GOLD, struck on its own
  //      latest library close. Append-only.
  {
    instrument:"Gold", asset_class:"metal",
    anchor_date:"2026-09-01", run_date:"2026-09-01", anchor_price:4369.32, ccy:"USD",
    horizon_label:"1 month", grade_date:"2026-10-01", grade_basis:"projected", horizon_days:22,
    cycle_no:3, reanchor_from:"2026-07-27", anchor_vol:0.2097,
    signal_z:0.0, signal_alpha:0.0,
    ...
    p5:3982.91, p25:4222.87, p50:4381.36, p75:4548.44, p95:4825.14,
    touch:{ "+5":34, "+10":9, "+15":2, "+20":0, "-5":29, "-10":5 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  {
    instrument:"Gold", asset_class:"metal",
    anchor_date:"2026-09-01", run_date:"2026-09-01", anchor_price:4369.32, ccy:"USD",
    horizon_label:"3 months", grade_date:"2026-12-01", grade_basis:"projected", horizon_days:65,
    cycle_no:3, reanchor_from:"2026-07-27", anchor_vol:0.2065,
    signal_z:0.0, signal_alpha:0.0,
    note:"Cycle 3 roll-forward, 01-Sep-2026 — struck on the 01-Sep-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-27 and is graded in this same pass. The previous cone was anchored 2026-07-27; every still-open cohort on cycle 2 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal OFF. q_annual=0 (q=0 is SOURCED, not defaulted: a spot metal pays no holder yield — the lease rate is a borrower’s cost, not a return to the holder — so the carry is rf alone.) XAU live fit nu=12.0, width_cal=0.958. rf_live 3.63% Fed funds midpoint schedule (USD cost-of-carry anchor). No direction call: this market carries no surviving momentum cell, so the cone is carry-centered. Horizons resolved by horizons.resolve() on XAU’s own realized calendar — a calendar commitment, not a session count; the session counts (h=22 / 65) size the cone only.",
    p5:3752.26, p25:4139.43, p50:4411.09, p75:4702.87, p95:5185.39,
    touch:{ "+5":59, "+10":32, "+15":15, "+20":7, "-5":51, "-10":22 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  ...
  {
    instrument:"COMI", asset_class:"equity",
    anchor_date:"2026-09-01", run_date:"2026-09-01", anchor_price:139.0, ccy:"EGP",
    horizon_label:"1 month", grade_date:"2026-10-01", grade_basis:"projected", horizon_days:20,
    cycle_no:4, reanchor_from:"2026-07-28", anchor_vol:0.2616,
    signal_z:0.7856, signal_alpha:0.003378,
    note:"Cycle 4 roll-forward, 01-Sep-2026 — struck on the 01-Sep-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-30 and is graded in this same pass. The previous cone was anchored 2026-07-28; every still-open cohort on cycle 3 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) EG live fit nu=5.0, width_cal=0.958. PER-NAME WIDTH OVERLAY APPLIED (engine/adaptive_width.py): this name has cleared the 28-window history gate, so live_width_mult() returns 0.9823 on its OWN resolved 3-month residuals and the cone was simulated at an effective width_cal of 0.9410, not the pooled 0.958. It is an OVERLAY, NOT A REFIT: the pooled (nu, width_cal), the carry drift and the tail nu are untouched by it. rf_live 19.50% CBE main operation rate. Direction call UP, from this name’s own mom_combo z of +0.786 (outside the 0.25 dead zone); tilt +0.34% at 1M and +0.70% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on EG’s own realized calendar — a calendar commitment, not a session count; the session counts (h=20 / 62) size the cone only.",
    p5:127.12, p25:136.18, p50:141.55, p75:147.14, p95:157.6,
    touch:{ "+5":44, "+10":16, "+15":5, "+20":2, "-5":24, "-10":6 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  {
    ...
    anchor_date:"2026-09-01", run_date:"2026-09-01", anchor_price:139.0, ccy:"EGP",
    horizon_label:"3 months", grade_date:"2026-12-01", grade_basis:"projected", horizon_days:62,
    cycle_no:4, reanchor_from:"2026-07-28", anchor_vol:0.2779,
    signal_z:0.7856, signal_alpha:0.00693,
    note:"Cycle 4 roll-forward, 01-Sep-2026 — struck on the 01-Sep-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-08-30 and is graded in this same pass. The previous cone was anchored 2026-07-28; every still-open cohort on cycle 3 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) EG live fit nu=5.0, width_cal=0.958. PER-NAME WIDTH OVERLAY APPLIED (engine/adaptive_width.py): this name has cleared the 28-window history gate, so live_width_mult() returns 0.9823 on its OWN resolved 3-month residuals and the cone was simulated at an effective width_cal of 0.9410, not the pooled 0.958. It is an OVERLAY, NOT A REFIT: the pooled (nu, width_cal), the carry drift and the tail nu are untouched by it. rf_live 19.50% CBE main operation rate. Direction call UP, from this name’s own mom_combo z of +0.786 (outside the 0.25 dead zone); tilt +0.34% at 1M and +0.70% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on EG’s own realized calendar — a calendar commitment, not a session count; the session counts (h=20 / 62) size the cone only.",
    p5:119.7, p25:136.21, p50:146.47, p75:157.5, p95:179.05,
    touch:{ "+5":75, "+10":51, "+15":32, "+20":19, "-5":43, "-10":19 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  ...
  //      latest library close. Append-only.
  {
    instrument:"PHAR", asset_class:"equity",
    anchor_date:"2026-09-06", run_date:"2026-09-06", anchor_price:128.0, ccy:"EGP",
    horizon_label:"1 month", grade_date:"2026-10-06", grade_basis:"projected", horizon_days:20,
    cycle_no:2, reanchor_from:"2026-08-06", anchor_vol:0.5506,
    signal_z:1.682, signal_alpha:0.013845,
    ...
    p5:106.97, p25:122.04, p50:131.42, p75:141.53, p95:161.41,
    touch:{ "+5":65, "+10":41, "+15":24, "+20":14, "-5":47, "-10":24 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  {
    ...
    anchor_date:"2026-09-06", run_date:"2026-09-06", anchor_price:128.0, ccy:"EGP",
    horizon_label:"3 months", grade_date:"2026-12-06", grade_basis:"projected", horizon_days:62,
    cycle_no:2, reanchor_from:"2026-08-06", anchor_vol:0.509,
    signal_z:1.682, signal_alpha:0.024714,
    note:"Cycle 2 roll-forward, 06-Sep-2026 — struck on the 06-Sep-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-09-06 and is graded in this same pass. The previous cone was anchored 2026-08-06; every still-open cohort on cycle 1 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0.027344 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) EG live fit nu=5.0, width_cal=0.951. PER-NAME WIDTH OVERLAY APPLIED (engine/adaptive_width.py): this name has cleared the 28-window history gate, so live_width_mult() returns 0.9000 on its OWN resolved 3-month residuals and the cone was simulated at an effective width_cal of 0.8559, not the pooled 0.951. It is an OVERLAY, NOT A REFIT: the pooled (nu, width_cal), the carry drift and the tail nu are untouched by it. rf_live 19.50% CBE main operation rate. Direction call UP, from this name’s own mom_combo z of +1.682 (outside the 0.25 dead zone); tilt +1.39% at 1M and +2.50% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on EG’s own realized calendar — a calendar commitment, not a session count; the session counts (h=20 / 62) size the cone only.",
  ...
  // ---- 06-Sep-2026 single-name roll-forward: SCEM, struck on its own
  //      latest library close. Append-only.
  {
    instrument:"SCEM", asset_class:"equity",
    anchor_date:"2026-09-06", run_date:"2026-09-06", anchor_price:98.52, ccy:"EGP",
    horizon_label:"1 month", grade_date:"2026-10-06", grade_basis:"projected", horizon_days:20,
    cycle_no:2, reanchor_from:"2026-08-06", anchor_vol:0.7674,
    signal_z:0.841, signal_alpha:0.01033,
    note:"Cycle 2 roll-forward, 06-Sep-2026 — struck on the 06-Sep-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-09-06 and is graded in this same pass. The previous cone was anchored 2026-08-06; every still-open cohort on cycle 1 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) EG live fit nu=5.0, width_cal=0.951. PER-NAME WIDTH OVERLAY APPLIED (engine/adaptive_width.py): this name has cleared the 28-window history gate, so live_width_mult() returns 0.9636 on its OWN resolved 3-month residuals and the cone was simulated at an effective width_cal of 0.9164, not the pooled 0.951. It is an OVERLAY, NOT A REFIT: the pooled (nu, width_cal), the carry drift and the tail nu are untouched by it. rf_live 19.50% CBE main operation rate. Direction call UP, from this name’s own mom_combo z of +0.841 (outside the 0.25 dead zone); tilt +1.04% at 1M and +2.09% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on EG’s own realized calendar — a calendar commitment, not a session count; the session counts (h=20 / 62) size the cone only.",
    p5:74.31, p25:90.45, p50:101.02, p75:112.84, p95:137.29,
    touch:{ "+5":71, "+10":54, "+15":39, "+20":28, "-5":61, "-10":40 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  {
    ...
    anchor_date:"2026-09-06", run_date:"2026-09-06", anchor_price:98.52, ccy:"EGP",
    horizon_label:"3 months", grade_date:"2026-12-06", grade_basis:"projected", horizon_days:62,
    cycle_no:2, reanchor_from:"2026-08-06", anchor_vol:0.796,
    signal_z:0.841, signal_alpha:0.020693,
    note:"Cycle 2 roll-forward, 06-Sep-2026 — struck on the 06-Sep-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-09-06 and is graded in this same pass. The previous cone was anchored 2026-08-06; every still-open cohort on cycle 1 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) EG live fit nu=5.0, width_cal=0.951. PER-NAME WIDTH OVERLAY APPLIED (engine/adaptive_width.py): this name has cleared the 28-window history gate, so live_width_mult() returns 0.9636 on its OWN resolved 3-month residuals and the cone was simulated at an effective width_cal of 0.9164, not the pooled 0.951. It is an OVERLAY, NOT A REFIT: the pooled (nu, width_cal), the carry drift and the tail nu are untouched by it. rf_live 19.50% CBE main operation rate. Direction call UP, from this name’s own mom_combo z of +0.841 (outside the 0.25 dead zone); tilt +1.04% at 1M and +2.09% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on EG’s own realized calendar — a calendar commitment, not a session count; the session counts (h=20 / 62) size the cone only.",
    p5:60.04, p25:86.09, p50:105.42, p75:129.08, p95:184.57,
    touch:{ "+5":86, "+10":76, "+15":66, "+20":57, "-5":76, "-10":60 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },

  // ---- 2026-09-06 single-name roll-forward: SWDY, struck on its own
  //      latest library close. Append-only.
  {
    instrument:"SWDY", asset_class:"equity",
    anchor_date:"2026-09-06", run_date:"2026-09-06", anchor_price:136.2, ccy:"EGP",
    horizon_label:"1 month", grade_date:"2026-10-06", grade_basis:"projected", horizon_days:20,
    cycle_no:2, reanchor_from:"2026-08-05", anchor_vol:0.5157,
    signal_z:1.0324, signal_alpha:0.008241,
    note:"Cycle 2 roll-forward, 2026-09-06 — struck on the 06-Sep-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-09-06 and is graded in this same pass. The previous cone was anchored 2026-08-05; every still-open cohort on cycle 1 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0.0073 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) EG live fit nu=5.0, width_cal=0.951. PER-NAME WIDTH OVERLAY APPLIED (engine/adaptive_width.py): this name has cleared the 28-window history gate, so live_width_mult() returns 0.9317 on its OWN resolved 3-month residuals and the cone was simulated at an effective width_cal of 0.8861, not the pooled 0.951. It is an OVERLAY, NOT A REFIT: the pooled (nu, width_cal), the carry drift and the tail nu are untouched by it. rf_live 19.50% CBE main operation rate. Direction call UP, from this name’s own mom_combo z of +1.032 (outside the 0.25 dead zone); tilt +0.83% at 1M and +1.54% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on EG’s own realized calendar — a calendar commitment, not a session count; the session counts (h=20 / 62) size the cone only.",
    p5:114.09, p25:129.63, p50:139.29, p75:149.67, p95:170.01,
    touch:{ "+5":63, "+10":38, "+15":22, "+20":13, "-5":47, "-10":23 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  {
    ...
    anchor_date:"2026-09-06", run_date:"2026-09-06", anchor_price:136.2, ccy:"EGP",
    horizon_label:"3 months", grade_date:"2026-12-06", grade_basis:"projected", horizon_days:62,
    cycle_no:2, reanchor_from:"2026-08-05", anchor_vol:0.4951,
    signal_z:1.0324, signal_alpha:0.015278,
    note:"Cycle 2 roll-forward, 2026-09-06 — struck on the 06-Sep-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-09-06 and is graded in this same pass. The previous cone was anchored 2026-08-05; every still-open cohort on cycle 1 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0.0073 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) EG live fit nu=5.0, width_cal=0.951. PER-NAME WIDTH OVERLAY APPLIED (engine/adaptive_width.py): this name has cleared the 28-window history gate, so live_width_mult() returns 0.9317 on its OWN resolved 3-month residuals and the cone was simulated at an effective width_cal of 0.8861, not the pooled 0.951. It is an OVERLAY, NOT A REFIT: the pooled (nu, width_cal), the carry drift and the tail nu are untouched by it. rf_live 19.50% CBE main operation rate. Direction call UP, from this name’s own mom_combo z of +1.032 (outside the 0.25 dead zone); tilt +0.83% at 1M and +1.54% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on EG’s own realized calendar — a calendar commitment, not a session count; the session counts (h=20 / 62) size the cone only.",
    p5:103.03, p25:127.97, p50:144.55, p75:163.27, p95:202.44,
    touch:{ "+5":81, "+10":65, "+15":51, "+20":39, "-5":63, "-10":41 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  ...
  //      latest library close. Append-only.
  {
    instrument:"EGCH", asset_class:"equity",
    anchor_date:"2026-09-06", run_date:"2026-09-06", anchor_price:14.23, ccy:"EGP",
    horizon_label:"1 month", grade_date:"2026-10-06", grade_basis:"projected", horizon_days:20,
    cycle_no:2, reanchor_from:"2026-08-06", anchor_vol:0.4248,
    signal_z:0.5173, signal_alpha:0.003286,
    note:"Cycle 2 roll-forward, 06-Sep-2026 — struck on the 06-Sep-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-09-06 and is graded in this same pass. The previous cone was anchored 2026-08-06; every still-open cohort on cycle 1 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) EG live fit nu=5.0, width_cal=0.951. PER-NAME WIDTH OVERLAY APPLIED (engine/adaptive_width.py): this name has cleared the 28-window history gate, so live_width_mult() returns 0.9000 on its OWN resolved 3-month residuals and the cone was simulated at an effective width_cal of 0.8559, not the pooled 0.951. It is an OVERLAY, NOT A REFIT: the pooled (nu, width_cal), the carry drift and the tail nu are untouched by it. rf_live 19.50% CBE main operation rate. Direction call UP, from this name’s own mom_combo z of +0.517 (outside the 0.25 dead zone); tilt +0.33% at 1M and +0.69% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on EG’s own realized calendar — a calendar commitment, not a session count; the session counts (h=20 / 62) size the cone only.",
    p5:12.36, p25:13.68, p50:14.49, p75:15.34, p95:16.98,
    touch:{ "+5":56, "+10":29, "+15":14, "+20":7, "-5":40, "-10":16 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
  },
  {
    ...
    anchor_date:"2026-09-06", run_date:"2026-09-06", anchor_price:14.23, ccy:"EGP",
    horizon_label:"3 months", grade_date:"2026-12-06", grade_basis:"projected", horizon_days:62,
    cycle_no:2, reanchor_from:"2026-08-06", anchor_vol:0.4591,
    signal_z:0.5173, signal_alpha:0.006856,
    note:"Cycle 2 roll-forward, 06-Sep-2026 — struck on the 06-Sep-2026 close, the latest session in this name’s library, at the monthly metronome — the prior cycle’s 1-month matured on 2026-09-06 and is graded in this same pass. The previous cone was anchored 2026-08-06; every still-open cohort on cycle 1 stays OPEN and grades on its own terms; nothing retro-edited. Production chain, no approximation: Step 0.0 data-quality gate → YZ variance proxy → fit_har_v3 → har_forecast_v3 → carry drift ln(1+rf_live)−ln(1+q) → simulate_paths_v3, 50,000 paths, seed 42, signal ON. q_annual=0 (FLAGGED — house convention; the drift is a GROSS-OF-DIVIDEND price carry and overstates the centre by roughly the yield.) EG live fit nu=5.0, width_cal=0.951. PER-NAME WIDTH OVERLAY APPLIED (engine/adaptive_width.py): this name has cleared the 28-window history gate, so live_width_mult() returns 0.9000 on its OWN resolved 3-month residuals and the cone was simulated at an effective width_cal of 0.8559, not the pooled 0.951. It is an OVERLAY, NOT A REFIT: the pooled (nu, width_cal), the carry drift and the tail nu are untouched by it. rf_live 19.50% CBE main operation rate. Direction call UP, from this name’s own mom_combo z of +0.517 (outside the 0.25 dead zone); tilt +0.33% at 1M and +0.69% at 3M, applied through the engine’s per-market signal socket at the horizon’s own measured ic and capped at ic x sigma x z. Horizons resolved by horizons.resolve() on EG’s own realized calendar — a calendar commitment, not a session count; the session counts (h=20 / 62) size the cone only.",
    p5:11.08, p25:13.45, p50:15.0, p75:16.73, p95:20.28,
    touch:{ "+5":79, "+10":62, "+15":46, "+20":34, "-5":60, "-10":37 },
    realized_close:null, realized_high:null, realized_low:null,
    in_90:null, in_50:null, realized_quantile:null, median_err:null,
    touch_hit:{ "+5":null, "+10":null, "+15":null, "+20":null, "-5":null, "-10":null }
...
const METALS = {
 ...
 name:"Gold", code:"XAU/USD", spot:4369, spotDate:"close 01 Sep 2026", ccy:"USD",
 fair:{ bear:4200, base:4600, full:5000 },
 dist: {
   t20: { label:"1 month",   p5:3983, p25:4223, p50:4381, p75:4548, p95:4825, resolve:"2026-10-01" },
   t60: { label:"3 months",  p5:3752, p25:4139, p50:4411, p75:4703, p95:5185, resolve:"2026-12-01" },
 ...
 fit: { nu:12, cal:0.958, mult:1, eff:0.958, on:"2026-09-01" },
 touch: [ /* descending high -> low */
   [4800, 9, 32], [4600, 32, 57], [4500, 54, 73], [4300, 67, 79], [4200, 39, 59], [3800, 2, 12], [3700, 1, 7], [3600, 0, 4], [3500, 0, 2]
 ],
 levels: { res:[4501, 4577, 4697], sup:[4209, 3973, 3420] },
 tech: {
   trend: "Mixed against the moving-average stack, below a rising 200-day",
   summary: "The price closed 4369 below a rising 20-day (4445) and a rising 200-day (4533), but above a rising 50-day (4218). Momentum is neutral: RSI(14) is ~49 and the daily ATR near 101 (~2.3%) points to a normal tape. MACD (12\u00b726\u00b79) is above zero but rolling over (+82 / +100 / \u221217). Over the last year it has ranged 3628\u20135595; the last close sits 22% below that high and 20% above that low.",
   bull: "A daily close back above 4501 would clear the nearest resistance; the next charted level above it is 4697.",
   bear: "A close below 4209 would break the nearest support; the next charted level below it is 3420."
 },
 asof: {
   mc:   { data:"2026-09-01", computed:"2026-09-01" },
   tech: { data:"2026-09-01", computed:"2026-09-07" }
...
const CALIB = {
  ...
  "ADX:ALDAR": {w: 58, in50: 43, in90: 86, through: "2026-08-05"},
  "ADX:ALPHADHABI": {w: 16, in50: 38, in90: 100, through: "2026-07-27"},
  "ADX:AMR": {w: 10, in50: 10, in90: 100, through: "2026-06-25"},
  ...
  "EGX:COMI": {w: 57, in50: 40, in90: 89, through: "2026-07-12"},
  "EGX:DSCW": {w: 29, in50: 52, in90: 93, through: "2026-06-15"},
  "EGX:EFID": {w: 40, in50: 60, in90: 95, through: "2026-06-16"},
  "EGX:EFIH": {w: 15, in50: 53, in90: 100, through: "2026-08-18"},
  "EGX:EGAL": {w: 57, in50: 56, in90: 89, through: "2026-07-22"},
  "EGX:EGCH": {w: 57, in50: 54, in90: 93, through: "2026-07-12"},
  ...
  "EGX:HELI": {w: 57, in50: 54, in90: 89, through: "2026-07-12"},
  "EGX:HRHO": {w: 57, in50: 51, in90: 86, through: "2026-07-12"},
  "EGX:ISPH": {w: 30, in50: 40, in90: 77, through: "2026-07-22"},
  "EGX:JUFO": {w: 57, in50: 61, in90: 93, through: "2026-07-14"},
  "EGX:KABO": {w: 57, in50: 39, in90: 91, through: "2026-08-03"},
  "EGX:LCSW": {w: 57, in50: 47, in90: 89, through: "2026-07-26"},
  "EGX:OCDI": {w: 57, in50: 42, in90: 95, through: "2026-07-12"},
  "EGX:OIH": {w: 53, in50: 55, in90: 96, through: "2026-06-02"},
  "EGX:ORAS": {w: 41, in50: 44, in90: 88, through: "2026-07-12"},
  "EGX:ORHD": {w: 41, in50: 51, in90: 90, through: "2026-07-22"},
  "EGX:ORWE": {w: 57, in50: 54, in90: 88, through: "2026-07-22"},
  "EGX:PHAR": {w: 56, in50: 54, in90: 98, through: "2026-06-24"},
  "EGX:PHDC": {w: 57, in50: 47, in90: 89, through: "2026-07-12"},
  "EGX:PRDC": {w: 15, in50: 60, in90: 93, through: "2026-08-11"},
  "EGX:RAYA": {w: 57, in50: 70, in90: 93, through: "2026-07-12"},
  "EGX:RMDA": {w: 22, in50: 50, in90: 95, through: "2026-07-22"},
  "EGX:SCEM": {w: 57, in50: 70, in90: 93, through: "2026-07-22"},
  "EGX:SWDY": {w: 57, in50: 47, in90: 95, through: "2026-07-12"},
  ...
  "TADAWUL:2010": {w: 58, in50: 50, in90: 93, through: "2026-07-28"},
...
const SCREEN = {
  ...
  AAPL: { px: 325.31, pxDate: "2026-09-03", lib: "2026-09-01", z: 0.835, trend: true, gap: -0.3606, fair: 208, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 58, c90: 0.8621, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  ABUK: { px: 94, pxDate: "2026-09-03", lib: "2026-08-23", z: -1.21, trend: true, gap: -0.3617, fair: 60, fairAsof: "2026-07-01", rebuilt: false, notes: null, n: 57, c90: 0.9123, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  ACWA: { px: 192.7, pxDate: "2026-09-03", lib: "2026-08-31", z: 0.478, trend: false, gap: 0.0119, fair: 195, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 15, c90: 0.8667, flag: null, cap: "thin record", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  ADCB: { px: 15.14, pxDate: "2026-09-03", lib: "2026-08-21", z: 0.345, trend: true, gap: 0.3012, fair: 19.7, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 58, c90: 0.8621, flag: null, cap: "full", stop: null, why: "clears every gate on the published numbers" },
  ADIB: { px: 52.05, pxDate: "2026-09-03", lib: "2026-08-23", z: 1.066, trend: true, gap: 0.0432, fair: 54.3, fairAsof: "2026-07-01", rebuilt: false, notes: null, n: 57, c90: 0.9474, flag: null, cap: "full", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  ADIBUAE: { px: 22.66, pxDate: "2026-09-03", lib: null, z: null, trend: null, gap: null, fair: 21.23, fairAsof: null, rebuilt: false, notes: null, n: 58, c90: 0.8621, flag: null, cap: null, stop: "inputs", why: "momentum not computable" },
  ADNOCDIST: { px: 4.02, pxDate: "2026-09-03", lib: "2026-08-07", z: 0.592, trend: true, gap: 0.097, fair: 4.41, fairAsof: "2026-08-07", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 30, c90: 1, flag: null, cap: "partial", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  ADNOCDRILL: { px: 5.8, pxDate: "2026-09-03", lib: "2026-08-07", z: 1.096, trend: false, gap: -0.1517, fair: 4.92, fairAsof: "2026-08-07", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 15, c90: 1, flag: null, cap: "thin record", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  ADNOCGAS: { px: 3.2, pxDate: "2026-09-03", lib: "2026-08-21", z: 0.274, trend: false, gap: 0.1844, fair: 3.79, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 9, c90: 1, flag: null, cap: "thin record", stop: "lenses", why: "tape is not constructive" },
  ADNOCLS: { px: 6.85, pxDate: "2026-09-03", lib: "2026-08-07", z: 1.312, trend: true, gap: 0.0292, fair: 7.05, fairAsof: "2026-08-07", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 8, c90: 0.875, flag: null, cap: "thin record", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  AGTHIA: { px: 3.29, pxDate: "2026-09-03", lib: "2026-08-21", z: -0.796, trend: false, gap: 0.3283, fair: 4.37, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 58, c90: 0.9655, flag: null, cap: "full", stop: "lenses", why: "momentum call is down; tape is not constructive" },
  AIRARABIA: { px: 4.97, pxDate: "2026-09-03", lib: "2026-08-07", z: 0.897, trend: true, gap: -0.161, fair: 4.17, fairAsof: "2026-08-07", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 58, c90: 0.8621, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  ALDAR: { px: 7.6, pxDate: "2026-09-03", lib: "2026-08-21", z: -1.43, trend: false, gap: 0.3395, fair: 10.18, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 58, c90: 0.8966, flag: null, cap: "full", stop: "momentum", why: "strong negative direction call" },
  ALINMA: { px: 25, pxDate: "2026-09-03", lib: "2026-08-31", z: 0.7, trend: true, gap: 0.0928, fair: 27.32, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 58, c90: 0.8621, flag: null, cap: "full", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  ALPHADHABI: { px: 7.3, pxDate: "2026-09-03", lib: "2026-08-21", z: -1.342, trend: false, gap: -0.0233, fair: 7.13, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 16, c90: 1, flag: null, cap: "thin record", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  ALRAJHI: { px: 66.2, pxDate: "2026-09-03", lib: "2026-08-31", z: 0.077, trend: false, gap: 0.0574, fair: 70, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 58, c90: 0.8621, flag: null, cap: "full", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  AMOC: { px: 13.54, pxDate: "2026-09-06", lib: "2026-09-06", z: -1.032, trend: true, gap: -0.5606, fair: 5.95, fairAsof: "2026-08-06", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 57, c90: 0.8947, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  AMR: { px: 2.39, pxDate: "2026-09-03", lib: "2026-08-07", z: 1.387, trend: true, gap: -0.1004, fair: 2.15, fairAsof: "2026-08-07", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 10, c90: 1, flag: null, cap: "thin record", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  ARAMCO: { px: 26.02, pxDate: "2026-09-03", lib: "2026-08-31", z: 0.404, trend: false, gap: -0.0377, fair: 25.04, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 22, c90: 0.9091, flag: null, cap: "partial", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  ARCC: { px: 76.6, pxDate: "2026-09-06", lib: "2026-09-06", z: -0.387, trend: true, gap: -0.2866, fair: 54.65, fairAsof: "2026-06-30", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 44, c90: 0.9318, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  BOROUGE: { px: 2.35, pxDate: "2026-09-03", lib: "2026-08-07", z: -0.146, trend: false, gap: -0.3702, fair: 1.48, fairAsof: "2026-08-07", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 12, c90: 1, flag: null, cap: "thin record", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  BTFH: { px: 3.02, pxDate: "2026-09-03", lib: "2026-08-23", z: -1.146, trend: false, gap: -0.0464, fair: 2.88, fairAsof: "2026-07-01", rebuilt: false, notes: null, n: 56, c90: 0.8393, flag: null, cap: "full", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  BURJEEL: { px: 1.24, pxDate: "2026-09-03", lib: "2026-08-21", z: -0.124, trend: false, gap: 0.4919, fair: 1.85, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 11, c90: 0.9091, flag: null, cap: "thin record", stop: "lenses", why: "tape is not constructive" },
  CCAP: { px: 5.9, pxDate: "2026-09-03", lib: "2026-08-23", z: 0.513, trend: true, gap: -0.0017, fair: 5.89, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 57, c90: 0.8421, flag: null, cap: "full", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  CLHO: { px: 17.88, pxDate: "2026-09-03", lib: "2026-08-23", z: 0.311, trend: true, gap: -0.4849, fair: 9.21, fairAsof: "2026-07-12", rebuilt: false, notes: null, n: 36, c90: 0.9722, flag: null, cap: "partial", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  COMI: { px: 138.98, pxDate: "2026-09-03", lib: "2026-09-01", z: -0.428, trend: true, gap: -0.1128, fair: 123.3, fairAsof: "2026-06-29", rebuilt: false, notes: null, n: 57, c90: 0.9123, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  DEWA: { px: 2.7, pxDate: "2026-09-03", lib: "2026-08-21", z: 0.069, trend: false, gap: 0.2296, fair: 3.32, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 13, c90: 1, flag: null, cap: "thin record", stop: "lenses", why: "tape is not constructive" },
  DIB: { px: 7.2, pxDate: "2026-09-03", lib: "2026-08-21", z: -0.766, trend: false, gap: 0.4139, fair: 10.18, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 58, c90: 0.8621, flag: null, cap: "full", stop: "lenses", why: "momentum call is down; tape is not constructive" },
  DSCW: { px: 2.03, pxDate: "2026-09-02", lib: "2026-08-23", z: -0.794, trend: true, gap: -0.5665, fair: 0.88, fairAsof: "2026-07-19", rebuilt: false, notes: null, n: 29, c90: 0.931, flag: null, cap: "partial", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  DU: { px: 11.36, pxDate: "2026-09-03", lib: "2026-08-07", z: 1.299, trend: true, gap: 0.2236, fair: 13.9, fairAsof: "2026-08-07", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 58, c90: 0.9483, flag: null, cap: "full", stop: null, why: "clears every gate on the published numbers" },
  EAND: { px: 21.18, pxDate: "2026-09-03", lib: "2026-08-21", z: 0.784, trend: true, gap: 0.0727, fair: 22.72, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 58, c90: 0.9138, flag: null, cap: "full", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  EFID: { px: 30.79, pxDate: "2026-09-03", lib: "2026-08-23", z: -0.123, trend: true, gap: -0.101, fair: 27.68, fairAsof: "2026-07-01", rebuilt: false, notes: null, n: 40, c90: 0.95, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  EFIH: { px: 22.97, pxDate: "2026-09-03", lib: "2026-08-23", z: -0.152, trend: true, gap: -0.3835, fair: 14.16, fairAsof: "2026-07-01", rebuilt: false, notes: null, n: 15, c90: 1, flag: null, cap: "thin record", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  EGAL: { px: 381, pxDate: "2026-09-03", lib: "2026-08-23", z: -0.407, trend: true, gap: -0.3438, fair: 250, fairAsof: "2026-07-01", rebuilt: false, notes: null, n: 57, c90: 0.9123, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  EGCH: { px: 14.41, pxDate: "2026-09-03", lib: "2026-08-06", z: -0.9, trend: true, gap: -0.7474, fair: 3.64, fairAsof: "2026-08-06", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 57, c90: 0.9474, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  ELEC: { px: 2.12, pxDate: "2026-09-06", lib: "2026-09-06", z: -1.565, trend: false, gap: -0.8396, fair: 0.34, fairAsof: "2026-08-05", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 57, c90: 0.9298, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  ELM: { px: 608.5, pxDate: "2026-09-03", lib: "2026-08-31", z: -0.076, trend: false, gap: 0.0189, fair: 620, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 13, c90: 0.6923, flag: null, cap: "thin record", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  EMAAR: { px: 10.8, pxDate: "2026-09-03", lib: "2026-08-27", z: -1.488, trend: false, gap: 0.3704, fair: 14.8, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 58, c90: 0.7931, flag: "narrow", cap: "reduced", stop: "momentum", why: "strong negative direction call" },
  EMAARDEV: { px: 13.38, pxDate: "2026-09-03", lib: "2026-08-27", z: -1.199, trend: false, gap: 0.2922, fair: 17.29, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 30, c90: 0.9333, flag: null, cap: "partial", stop: "momentum", why: "strong negative direction call" },
  EMFD: { px: 13.8, pxDate: "2026-09-03", lib: "2026-09-01", z: -0.291, trend: true, gap: 0.4377, fair: 19.84, fairAsof: "2026-06-17", rebuilt: false, notes: null, n: 40, c90: 0.975, flag: null, cap: "full", stop: "lenses", why: "momentum call is down" },
  EMPOWER: { px: 1.57, pxDate: "2026-09-03", lib: "2026-08-07", z: -0.156, trend: false, gap: 0.172, fair: 1.84, fairAsof: "2026-08-07", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 10, c90: 1, flag: null, cap: "thin record", stop: "lenses", why: "tape is not constructive" },
  ENBD: { px: 30.28, pxDate: "2026-09-03", lib: "2026-08-27", z: 0.64, trend: true, gap: 0.0667, fair: 32.3, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 57, c90: 0.9123, flag: null, cap: "full", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  ETEL: { px: 115, pxDate: "2026-09-03", lib: "2026-08-23", z: 0.654, trend: true, gap: 0.0261, fair: 118, fairAsof: "2026-07-01", rebuilt: false, notes: null, n: 57, c90: 0.9825, flag: "wide", cap: "full", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  EXTRA: { px: 66.05, pxDate: "2026-09-03", lib: "2026-08-31", z: -1.445, trend: false, gap: 0.2263, fair: 81, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 54, c90: 0.8519, flag: null, cap: "full", stop: "momentum", why: "strong negative direction call" },
  FAB: { px: 19.4, pxDate: "2026-09-03", lib: "2026-08-27", z: 0.846, trend: true, gap: 0.0258, fair: 19.9, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 58, c90: 0.931, flag: null, cap: "full", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  FERTIGLB: { px: 2.67, pxDate: "2026-09-03", lib: "2026-08-07", z: 0.589, trend: false, gap: -0.1948, fair: 2.15, fairAsof: "2026-08-07", rebuilt: false, notes: null, n: 14, c90: 1, flag: null, cap: "thin record", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  FWRY: { px: 18.95, pxDate: "2026-09-03", lib: "2026-08-23", z: -0.66, trend: true, gap: -0.2243, fair: 14.7, fairAsof: "2026-07-01", rebuilt: false, notes: null, n: 23, c90: 1, flag: null, cap: "partial", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  GBCO: { px: 28.98, pxDate: "2026-09-03", lib: "2026-08-23", z: -0.703, trend: true, gap: 0.2319, fair: 35.7, fairAsof: "2026-07-07", rebuilt: false, notes: null, n: 57, c90: 0.9474, flag: null, cap: "full", stop: "lenses", why: "momentum call is down" },
  HELI: { px: 8.1, pxDate: "2026-09-03", lib: "2026-08-23", z: 1.301, trend: true, gap: 0.037, fair: 8.4, fairAsof: "2026-07-01", rebuilt: false, notes: null, n: 57, c90: 0.9123, flag: null, cap: "full", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  HRHO: { px: 25.7, pxDate: "2026-09-03", lib: "2026-08-23", z: -1.167, trend: false, gap: 0.0778, fair: 27.7, fairAsof: "2026-07-01", rebuilt: false, notes: null, n: 57, c90: 0.9298, flag: null, cap: "full", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  IHC: { px: 369, pxDate: "2026-09-03", lib: "2026-08-31", z: 0.116, trend: false, gap: -0.7168, fair: 104.5, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 47, c90: 0.8511, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  INFY: { px: 1132.5, pxDate: "2026-09-03", lib: "2026-09-01", z: -0.902, trend: false, gap: 0.0967, fair: 1242, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 58, c90: 0.8966, flag: null, cap: "full", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  IQCD: { px: 13.17, pxDate: "2026-09-03", lib: "2026-09-01", z: -0.944, trend: false, gap: -0.1724, fair: 10.9, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 58, c90: 0.8966, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  ISPH: { px: 12.95, pxDate: "2026-09-03", lib: "2026-08-23", z: -0.501, trend: true, gap: 0.373, fair: 17.78, fairAsof: "2026-07-07", rebuilt: false, notes: null, n: 30, c90: 0.7667, flag: "narrow", cap: "reduced", stop: "lenses", why: "momentum call is down" },
  JUFO: { px: 27.06, pxDate: "2026-09-03", lib: "2026-08-23", z: -0.235, trend: true, gap: -0.0392, fair: 26, fairAsof: "2026-07-01", rebuilt: false, notes: null, n: 57, c90: 0.9474, flag: null, cap: "full", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  KABO: { px: 34.06, pxDate: "2026-09-03", lib: "2026-08-23", z: 0.017, trend: true, gap: -0.9298, fair: 2.39, fairAsof: "2026-07-06", rebuilt: false, notes: null, n: 57, c90: 0.9474, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  KAKAO: { px: 35100, pxDate: "2026-09-03", lib: "2026-09-01", z: -0.733, trend: false, gap: null, fair: 34258, fairAsof: null, rebuilt: false, notes: null, n: null, c90: null, flag: null, cap: null, stop: "inputs", why: "no band record" },
  LCSW: { px: 36, pxDate: "2026-09-02", lib: "2026-08-23", z: -0.333, trend: true, gap: 0.0278, fair: 37, fairAsof: "2026-07-06", rebuilt: false, notes: null, n: 57, c90: 0.9123, flag: null, cap: "full", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  LGES: { px: 364000, pxDate: "2026-09-03", lib: "2026-09-01", z: -0.403, trend: false, gap: -0.3187, fair: 248000, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 14, c90: 0.9286, flag: null, cap: "thin record", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  LULU: { px: 0.94, pxDate: "2026-09-03", lib: "2026-08-27", z: -0.661, trend: false, gap: 0.3617, fair: 1.28, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 2, c90: 1, flag: null, cap: "thin record", stop: "lenses", why: "momentum call is down; tape is not constructive" },
  MAADEN: { px: 65.7, pxDate: "2026-09-03", lib: "2026-08-31", z: -0.179, trend: true, gap: -0.3607, fair: 42, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 58, c90: 0.8793, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  MODON: { px: 2.83, pxDate: "2026-09-03", lib: "2026-08-07", z: -0.838, trend: false, gap: -0.1166, fair: 2.5, fairAsof: "2026-08-07", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 23, c90: 0.8696, flag: null, cap: "partial", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  NVDA: { px: 217.11, pxDate: "2026-09-03", lib: "2026-08-31", z: 0.255, trend: true, gap: -0.0604, fair: 204, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 58, c90: 0.8621, flag: null, cap: "full", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  OCDI: { px: 33.52, pxDate: "2026-09-02", lib: "2026-09-01", z: 1.057, trend: true, gap: -0.2115, fair: 26.43, fairAsof: "2026-06-23", rebuilt: false, notes: null, n: 57, c90: 0.9474, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  OIH: { px: 2.01, pxDate: "2026-09-03", lib: "2026-08-23", z: -0.139, trend: true, gap: -0.6119, fair: 0.78, fairAsof: "2026-07-01", rebuilt: false, notes: null, n: 53, c90: 0.9623, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  ORAS: { px: 831.5, pxDate: "2026-09-03", lib: "2026-08-23", z: 0.58, trend: true, gap: 0.1161, fair: 928, fairAsof: "2026-06-30", rebuilt: false, notes: null, n: 41, c90: 0.878, flag: null, cap: "full", stop: null, why: "clears every gate on the published numbers" },
  ORHD: { px: 42, pxDate: "2026-09-03", lib: "2026-09-01", z: 1.037, trend: true, gap: 0.2807, fair: 53.79, fairAsof: "2026-06-24", rebuilt: false, notes: null, n: 41, c90: 0.9268, flag: null, cap: "full", stop: null, why: "clears every gate on the published numbers" },
  ORWE: { px: 26.76, pxDate: "2026-09-02", lib: "2026-08-23", z: -0.919, trend: true, gap: -0.219, fair: 20.9, fairAsof: "2026-07-01", rebuilt: false, notes: null, n: 57, c90: 0.9123, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  PHAR: { px: 128, pxDate: "2026-09-06", lib: "2026-09-06", z: 1.273, trend: true, gap: -0.5218, fair: 61.21, fairAsof: "2026-08-06", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 56, c90: 1, flag: "wide", cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  PHDC: { px: 14.4, pxDate: "2026-09-03", lib: "2026-08-23", z: 1.172, trend: true, gap: 0.1035, fair: 15.89, fairAsof: "2026-06-11", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 57, c90: 0.9123, flag: null, cap: "full", stop: null, why: "clears every gate on the published numbers" },
  PRDC: { px: 9.78, pxDate: "2026-09-03", lib: "2026-08-23", z: 2.844, trend: true, gap: -0.1585, fair: 8.23, fairAsof: "2026-07-06", rebuilt: false, notes: null, n: 15, c90: 1, flag: null, cap: "thin record", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  QGTS: { px: 4.85, pxDate: "2026-09-03", lib: "2026-09-01", z: 0.781, trend: false, gap: -0.1155, fair: 4.29, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 58, c90: 0.9483, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  QNB: { px: 16.67, pxDate: "2026-09-06", lib: "2026-09-06", z: 0.162, trend: false, gap: 0.1254, fair: 18.76, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 58, c90: 0.9483, flag: null, cap: "full", stop: "lenses", why: "tape is not constructive" },
  RAYA: { px: 7.15, pxDate: "2026-09-03", lib: "2026-08-23", z: 0.871, trend: true, gap: -0.2224, fair: 5.56, fairAsof: "2026-07-01", rebuilt: false, notes: null, n: 57, c90: 0.9298, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  RELIANCE: { px: 1308.8, pxDate: "2026-09-03", lib: "2026-09-01", z: 1.066, trend: false, gap: 0.0659, fair: 1395, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 58, c90: 0.931, flag: null, cap: "full", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  RIBL: { px: 20.48, pxDate: "2026-09-03", lib: "2026-08-31", z: 0.093, trend: true, gap: 0.2993, fair: 26.61, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 58, c90: 0.7759, flag: "narrow", cap: "reduced", stop: null, why: "clears every gate on the published numbers" },
  RIYADHCABLE: { px: 104.8, pxDate: "2026-09-03", lib: "2026-08-18", z: -1.115, trend: false, gap: 0.0434, fair: 109.35, fairAsof: "2026-08-18", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 10, c90: 0.9, flag: null, cap: "thin record", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  RMDA: { px: 5.91, pxDate: "2026-09-03", lib: "2026-08-23", z: 0.592, trend: true, gap: -0.5313, fair: 2.77, fairAsof: "2026-07-12", rebuilt: false, notes: null, n: 22, c90: 0.9545, flag: null, cap: "partial", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  SABIC: { px: 81.4, pxDate: "2026-09-03", lib: "2026-09-01", z: -0.816, trend: false, gap: -0.3182, fair: 55.5, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 58, c90: 0.9138, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  SALIK: { px: 5.4, pxDate: "2026-09-03", lib: "2026-08-27", z: -0.784, trend: false, gap: -0.1444, fair: 4.62, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 11, c90: 1, flag: null, cap: "thin record", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  SAMSUNG: { px: 250000, pxDate: "2026-09-03", lib: "2026-09-01", z: 1.136, trend: true, gap: null, fair: 296502, fairAsof: null, rebuilt: false, notes: null, n: null, c90: null, flag: null, cap: null, stop: "inputs", why: "no band record" },
  SAVOLA: { px: 30.3, pxDate: "2026-09-03", lib: "2026-08-18", z: 1.292, trend: false, gap: -0.101, fair: 27.24, fairAsof: "2026-08-18", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 58, c90: 0.9138, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  SCEM: { px: 98.52, pxDate: "2026-09-06", lib: "2026-09-06", z: -0.017, trend: true, gap: -0.4608, fair: 53.12, fairAsof: "2026-08-06", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 57, c90: 0.9298, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  SNB: { px: 42.14, pxDate: "2026-09-03", lib: "2026-08-31", z: 0.234, trend: true, gap: 0.0679, fair: 45, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 42, c90: 0.9286, flag: null, cap: "full", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  STC: { px: 43.86, pxDate: "2026-09-03", lib: "2026-08-31", z: 0.353, trend: false, gap: 0.0741, fair: 47.11, fairAsof: null, rebuilt: true, notes: "fair value carries no machine-readable date; a rebuilt study is in progress; this is the published number", n: 58, c90: 0.8793, flag: null, cap: "full", stop: "gap", why: "inside 10% of the price either way \u2014 no candidate" },
  SWDY: { px: 136.2, pxDate: "2026-09-06", lib: "2026-09-06", z: -0.229, trend: true, gap: -0.488, fair: 69.73, fairAsof: "2026-08-05", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 57, c90: 0.9474, flag: null, cap: "full", stop: "gap", why: "sits more than 10% below the price \u2014 audited, not traded" },
  TMGH: { px: 96.6, pxDate: "2026-09-02", lib: "2026-08-23", z: 0.051, trend: true, gap: 0.523, fair: 147.12, fairAsof: "2026-06-17", rebuilt: true, notes: "a rebuilt study is in progress; this is the published number", n: 57, c90: 0.9298, flag: null, cap: "full", stop: null, why: "clears every gate on the published numbers" },
  TMPV: { px: 310.1, pxDate: "2026-09-03", lib: "2026-09-01", z: -0.164, trend: false, gap: 0.219, fair: 378, fairAsof: null, rebuilt: false, notes: "fair value carries no machine-readable date", n: 58, c90: 0.8103, flag: "narrow", cap: "reduced", stop: "lenses", why: "tape is not constructive" },
