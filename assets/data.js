...
const TICKERS = {
  ...
  PHAR: {
    ...
    asof: {
      ...
      tech: { data:"2026-08-06", computed:"2026-08-17" }
    },
    files: {
  ...
  SWDY: {
    ...
    asof: {
      ...
      tech: { data:"2026-08-05", computed:"2026-08-17" }
    },
    files: {
  ...
  DEWA: {
    ...
    asof: {
      ...
      tech: { data:"2026-07-24", computed:"2026-08-17" }
    },
    files: {
  ...
  ELM: {
    ...
    asof: {
      ...
      tech: { data:"2026-07-26", computed:"2026-08-17" }
    },
    files: {
  ...
  GBCO: {
    ...
    spotDate: "close 22 Jul 2026",
    ccy: "EGP",
    fair: { bear: 19.9, base: 33.6, full: 44.6 },      // FUNDAMENTAL REFRESH 19 Aug 2026, r2 (re-issues the 08-Jul-2026 study on the H1-2026 disclosure set: KPMG-reviewed interim FS 30-Jun-2026 + 2Q/1H26 release, both 13-Aug-2026; model rebuilt BOTTOM-UP and FORMULA-PURE per instruction — FY26E derived from H1 + the FY25 measured seasonal split with explicit tempering inputs, CKD/CBU and bus/truck/CE unit layers, unit costs per physical class, margins as outputs; workbook 638 formulas / 326 annotated inputs / zero derived value-cells, independently re-evaluated cell-for-cell). Weighted central 33.6. BOTH WAYS, NEVER AVERAGED: MNT-Halan (stake 42.93% per FS note 34, superseding the release's post-second-closing 41.61%) at the Jun-26 round mark (USD 1.4bn x 50.71 -> SOTP 33.69, central 33.56 = published base) vs the company's OWN equity-method carrying (EGP 15.72bn, KPMG could not verify it — qualified review conclusion, 2nd consecutive period -> SOTP 21.46, central 28.66); bear 19.9 lives in the book-mark world, full 44.6 in the round-mark world. TERMINAL DISCIPLINE ADOPTED in r2 (ADNOCLS-modelled section-1 rewrite, 19-Aug instruction): TV = FY30E NOPAT x (1+g) x (1 - g/ROIC_t), ROIC_t 22.5% anchored on the leg's realized LTM ROCE 22.9% — the prior Gordon-on-FCFF hid an implied terminal ROIC of 25.5% and was worth +1.71/sh vs the disciplined base; both constructions shown and priced. Four lenses: split-legs SOTP (40%) 33.69/21.46, restated book & sustainable return (15%) 30.82, relative multiples (20%) 26.82 on FY26E EPS 2.82, normalized mid-cycle (25%) 40.37. WACC v2: rf* = 22.92 minus Egypt's own default spread (CDS 3.41 / rating 6.37), ERP 9.41/13.94 both bases, beta 0.893 via own_stock_beta vs EGX30 (n=255 weekly), Kd 20.82% = the filing's own H1-26 EGP average on an all-variable book -> WACC 22.72%/23.33%. Swing factors, in order: the MNT-Halan mark (12.23/sh between framings; the crux is priced as a ladder of second-close outcomes 1.0-1.6bn), terminal ROIC (at the forward model's transitional 15% the auto leg goes negative — priced, rejected as steady-state), the CBE path on an all-floating 43.5bn book, and auto GPM (one measured compression year carried; the compounding version priced and rejected). MC PASSES the calibration back-test with the secular drift ON (CRPS skill +3.2% non-overlapping, +9.6% monthly; zero drift FAILED) — entirely unaffected by any of this, since the engine prices the stock's own path, not the SOTP.
    ...
    files: {
      study: "files/GBCO_Valuation_Study_19-08-2026_public.docx?v=0819b",
      model: "files/GBCO_Valuation_Model_19082026_public.xlsx?v=0819b",
      pdf:   "files/GBCO_Valuation_Study_19-08-2026_public.pdf?v=0819b",
      biblio:"files/GBCO_Bibliography_19-08-2026.pdf?v=0819b"
    }
  },
  EMAARDEV: {
  ...
  RELIANCE: {
    ...
    asof: {
      ...
      tech: { data:"2026-07-28", computed:"2026-08-17" }
    },
    files: {
  ...
  NVDA: {
    ...
    asof: {
      ...
      tech: { data:"2026-07-27", computed:"2026-08-17" }
    },
    files: {
  ...
  LCSW: {
    ...
    asof: {
      ...
      tech: { data:"2026-07-21", computed:"2026-08-17" }
    },
    files: {
  ...
  TMPV: {
    ...
    asof: {
      ...
      tech: { data:"2026-08-03", computed:"2026-08-17" }
    },
    files: {
  ...
  ORAS: {
    ...
    asof: {
      ...
      tech: { data:"2026-07-29", computed:"2026-08-17" }
    },
    files: {
...
const METALS = {
 ...
 asof: {
   ...
   tech: { data:"2026-07-20", computed:"2026-08-17" }
 },
 files:{
