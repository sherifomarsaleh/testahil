...
const TICKERS = {
  ...
  GBCO: {
    ...
    spotDate: "close 23 Aug 2026",
    ccy: "EGP",
    fair: { bear: 15.8, base: 27.1, full: 34.3 },      // RE-ISSUED 30 Aug 2026 (fundamental update, v2 cost of capital) — weighted central 27.1 (-8% vs spot 29.51). What moved vs the 09-Jul 35.7: rf* now strips Egypt's own default spread (10Y 22.87% − 3.41% CDS basis), beta 0.89 regressed vs EGX30 (was 1.0 assumed), WACC 24.25% CDS-basis (was 22.94%), GB Capital ex-MNT at 1.0x book EGP 5.46bn (was 9.5bn earnings multiple), and the forecast rebuilt ground-up on a 15-year audited panel with the method walk-forward-trained on GBCO's own history (years 3-5 held as ranges). MNT-Halan stake DUAL-FRAMED, never averaged: carrying value EGP 12.85bn (audited, but qualified every period since FY24 — MNT-BV's own FS not provided) vs the June-2026 Al Ahly Capital round mark USD 1.4bn x 42.93% x 50.25 = EGP 30.2bn (41.61% after the announced second closing). Base stands on the round mark; bear stands on carrying. Four lenses: SOTP 35.4 (round-framing; 21.0 on carrying), pre-discount 39.3, relative 25.8 (5-9x blended FY26-27E EPS), normalized earnings power 7.4 (residual-income at Ke 27.8% — the discount-rate environment speaking); blend 40/15/20/25. In USD the market cap (~$637mn) roughly equals the stake's round mark alone (~$601mn). Swing factors: the MNT mark (largest), the CBE rate path (~1.5-2 EGP per 100bp), regional (Iraq/Jordan) loss fade-out, EGP step-devaluation risk. Full build: files/GBCO_Valuation_Update_30-08-2026.docx + engine/gbco_study/update_2026_08/ (inputs register, gates, WACC both bases); training record engine/gbco_training/.
    ...
    files: {
      ...
      update: "files/GBCO_Valuation_Update_30-08-2026.docx?v=0830"
    }
  },
  EMAARDEV: {
...
const CALIB = {
  ...
  "ADX:FAB": {w: 57, in50: 51, in90: 93, through: "2026-05-13"},
