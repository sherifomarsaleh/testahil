...
const TICKERS = {
  ...
  ARCC: {
    ...
    files: {
      study: "files/ARCC_Valuation_Study_01-09-2026_public.docx?v=0109a",
      model: "files/ARCC_Valuation_Model_01092026_public.xlsx?v=0109a",
